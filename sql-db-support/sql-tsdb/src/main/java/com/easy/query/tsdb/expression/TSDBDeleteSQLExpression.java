 ...
 * @author xuejiaming
 */
public class TSDBDeleteSQLExpression extends DeleteSQLExpressionImpl {

    public TSDBDeleteSQLExpression(EntitySQLExpressionMetadata entitySQLExpressionMetadata, EntityTableSQLExpression table) {
