 ...
 * @author xuejiaming
 */
public class ClickHouseInsertSQLExpression extends InsertSQLExpressionImpl {
    public ClickHouseInsertSQLExpression(EntitySQLExpressionMetadata entitySQLExpressionMetadata, EntityTableSQLExpression table) {
