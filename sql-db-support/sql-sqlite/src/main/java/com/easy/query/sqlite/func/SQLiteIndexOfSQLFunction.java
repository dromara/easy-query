 ...
 * @author xuejiaming
 */
public class SQLiteIndexOfSQLFunction extends AbstractSubStringExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public SQLiteIndexOfSQLFunction(List<ColumnExpression> columnExpressions) {
