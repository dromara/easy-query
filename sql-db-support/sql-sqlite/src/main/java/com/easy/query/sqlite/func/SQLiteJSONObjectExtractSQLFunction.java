 ...
 * @author xuejiaming
 */
public class SQLiteJSONObjectExtractSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public SQLiteJSONObjectExtractSQLFunction(List<ColumnExpression> concatExpressions) {
