 ...
 * @author xuejiaming
 */
public class MsSQLDateTimePlusSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final long duration;
    private final TimeUnit timeUnit;

    public MsSQLDateTimePlusSQLFunction(List<ColumnExpression> columnExpressions, long duration, TimeUnit timeUnit) {
    ...
    public String sqlSegment(TableAvailable defaultTable) {
        ...
        return "dateadd(second, ({1})/1000, {0})";
    }
