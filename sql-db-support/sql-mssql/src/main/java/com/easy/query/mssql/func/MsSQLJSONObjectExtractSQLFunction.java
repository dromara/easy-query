 ...
 * @author xuejiaming
 */
public class MsSQLJSONObjectExtractSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public MsSQLJSONObjectExtractSQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("MsSQLJSONObjectExtractSQLFunction columns empty");
        }
