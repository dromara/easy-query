 ...
 * @author xuejiaming
 */
public class MsSQLJSONObjectFieldSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public MsSQLJSONObjectFieldSQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("MsSQLJSONObjectFieldSQLFunction columns empty");
        }
