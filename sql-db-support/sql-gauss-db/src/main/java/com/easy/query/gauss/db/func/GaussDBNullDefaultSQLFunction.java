 ...
 * @author xuejiaming
 */
public class GaussDBNullDefaultSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;

    public GaussDBNullDefaultSQLFunction(List<ColumnExpression> columnExpressions) {
