 ...
 * @author xuejiaming
 */
public class GaussDBJSONObjectFieldSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public GaussDBJSONObjectFieldSQLFunction(List<ColumnExpression> concatExpressions) {
