 ...
 * @author xuejiaming
 */
public class GaussDBJSONObjectContainsKeySQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public GaussDBJSONObjectContainsKeySQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("PgSQLJSONObjectContainsKeySQLFunction columns empty");
        }
