 ...
 * @author xuejiaming
 */
public class GaussDBDateTimePlusYearSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;

    public GaussDBDateTimePlusYearSQLFunction(List<ColumnExpression> columnExpressions) {
