 ...
 * @author xuejiaming
 */
public class GaussDBCastSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final Class<?> targetClass;

    public GaussDBCastSQLFunction(List<ColumnExpression> columnExpressions, Class<?> targetClass) {
