 ...
 * @author xuejiaming
 */
public class GaussDBIndexOfSQLFunction extends AbstractSubStringExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public GaussDBIndexOfSQLFunction(List<ColumnExpression> columnExpressions) {
