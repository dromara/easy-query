 ...
 * @author xuejiaming
 */
public class GaussDBJSONArrayLengthSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public GaussDBJSONArrayLengthSQLFunction(List<ColumnExpression> concatExpressions) {
