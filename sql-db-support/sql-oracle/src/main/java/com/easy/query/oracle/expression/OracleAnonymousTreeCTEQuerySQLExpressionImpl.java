...
public class OracleAnonymousTreeCTEQuerySQLExpressionImpl implements AnonymousEntityQuerySQLExpression {
    ...
    public OracleAnonymousTreeCTEQuerySQLExpressionImpl(String cteTableName, EntitySQLExpressionMetadata entitySQLExpressionMetadata, EntityQuerySQLExpression querySQLExpression){
...
//    }
    ...
    public EntityQuerySQLExpression cloneSQLExpression() {
        return new OracleAnonymousTreeCTEQuerySQLExpressionImpl(this.cteTableName,entitySQLExpressionMetadata,querySQLExpression.cloneSQLExpression());
    }
}
