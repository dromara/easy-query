 ...
 * @author xuejiaming
 */
public class OracleDateTime2PlusSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final TimeUnitEnum timeUnit;

    public OracleDateTime2PlusSQLFunction(List<ColumnExpression> columnExpressions, TimeUnitEnum timeUnit) {
    ...
    public String sqlSegment(TableAvailable defaultTable) {
        ...
        throw new UnsupportedOperationException("not support current function OracleDateTime2PlusSQLFunction:"+ timeUnit);
    }
