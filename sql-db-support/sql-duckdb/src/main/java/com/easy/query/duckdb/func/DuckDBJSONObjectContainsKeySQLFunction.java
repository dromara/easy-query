 ...
 * @author xuejiaming
 */
public class DuckDBJSONObjectContainsKeySQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public DuckDBJSONObjectContainsKeySQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("DuckDBJSONObjectContainsKeySQLFunction columns empty");
        }
