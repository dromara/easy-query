 ...
 * @author xuejiaming
 */
public class DuckDBSQLCastSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final Class<?> targetClass;

    public DuckDBSQLCastSQLFunction(List<ColumnExpression> columnExpressions, Class<?> targetClass) {
