 ...
 * @author xuejiaming
 */
public class DuckDBSQLDateTimePropertySQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final DateTimeUnitEnum dateTimeUnitEnum;

    public DuckDBSQLDateTimePropertySQLFunction(List<ColumnExpression> columnExpressions, DateTimeUnitEnum dateTimeUnitEnum) {
    ...
    public String sqlSegment(TableAvailable defaultTable) {
        ...
        switch (dateTimeUnitEnum){
            ...
            case DayOfWeekSunDayLastDay:return "(CASE WHEN extract(dow from ({0})::timestamp) = 0 THEN 7 ELSE extract(dow from ({0})::timestamp) END)";
