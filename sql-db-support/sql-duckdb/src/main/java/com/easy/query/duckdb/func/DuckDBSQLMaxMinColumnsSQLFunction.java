 ...
 * @author xuejiaming
 */
public class DuckDBSQLMaxMinColumnsSQLFunction extends AbstractExpressionSQLFunction {
    private final boolean isMax;
    private final List<ColumnExpression> columnExpressions;

    public DuckDBSQLMaxMinColumnsSQLFunction(boolean isMax, List<ColumnExpression> columnExpressions) {
        this.isMax = isMax;
