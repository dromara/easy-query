 ...
 * @author xuejiaming
 */
public class DuckDBSQLDatabaseMigrationProvider extends AbstractDatabaseMigrationProvider {
    public DuckDBSQLDatabaseMigrationProvider(DataSource dataSource, SQLKeyword sqlKeyword, MigrationEntityParser migrationEntityParser) {
        super(dataSource, sqlKeyword, migrationEntityParser);
    }

    @Override
    public String databaseExistSQL(String databaseName) {
        throw new UnsupportedOperationException("duckdb database not support check database exists.");
    }

    @Override
    public String createDatabaseSQL(String databaseName) {
        throw new UnsupportedOperationException("duckdb database not support create database command.");
    }
    @Override
