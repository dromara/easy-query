 ...
 * @author xuejiaming
 */
public class DuckDBJSONObjectFieldSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public DuckDBJSONObjectFieldSQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("DuckDBJSONObjectFieldSQLFunction columns empty");
        }
