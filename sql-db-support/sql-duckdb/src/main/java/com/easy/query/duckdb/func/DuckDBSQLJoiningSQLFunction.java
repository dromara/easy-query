 ...
 * @author xuejiaming
 */
public class DuckDBSQLJoiningSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final boolean distinct;

    public DuckDBSQLJoiningSQLFunction(List<ColumnExpression> columnExpressions, boolean distinct) {
