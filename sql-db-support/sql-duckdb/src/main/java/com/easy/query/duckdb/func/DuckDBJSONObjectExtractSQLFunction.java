 ...
 * @author xuejiaming
 */
public class DuckDBJSONObjectExtractSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public DuckDBJSONObjectExtractSQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("DuckDBJSONObjectExtractSQLFunction columns empty");
        }
