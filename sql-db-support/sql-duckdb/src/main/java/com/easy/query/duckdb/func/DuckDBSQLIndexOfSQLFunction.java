 ...
 * @author xuejiaming
 */
public class DuckDBSQLIndexOfSQLFunction extends AbstractSubStringExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public DuckDBSQLIndexOfSQLFunction(List<ColumnExpression> columnExpressions) {
