 ...
 * @author xuejiaming
 */
public class KingbaseESDateTimePlusYearSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;

    public KingbaseESDateTimePlusYearSQLFunction(List<ColumnExpression> columnExpressions) {
