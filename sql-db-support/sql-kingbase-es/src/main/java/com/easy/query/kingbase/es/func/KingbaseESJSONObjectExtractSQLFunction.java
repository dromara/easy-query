 ...
 * @author xuejiaming
 */
public class KingbaseESJSONObjectExtractSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public KingbaseESJSONObjectExtractSQLFunction(List<ColumnExpression> concatExpressions) {
        if (EasyCollectionUtil.isEmpty(concatExpressions)) {
            throw new IllegalArgumentException("KingbaseESJSONObjectExtractSQLFunction columns empty");
        }
