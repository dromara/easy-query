 ...
 * @author xuejiaming
 */
public class KingbaseESMathSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final MathMethodEnum mathMethodEnum;

    public KingbaseESMathSQLFunction(List<ColumnExpression> columnExpressions, MathMethodEnum mathMethodEnum) {
