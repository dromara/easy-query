 ...
 * @author xuejiaming
 */
public class DB2InsertSQLExpression extends InsertSQLExpressionImpl {

    public DB2InsertSQLExpression(EntitySQLExpressionMetadata entitySQLExpressionMetadata, EntityTableSQLExpression table) {
