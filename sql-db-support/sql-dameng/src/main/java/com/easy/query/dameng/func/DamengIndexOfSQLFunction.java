 ...
 * @author xuejiaming
 */
public class DamengIndexOfSQLFunction extends AbstractSubStringExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public DamengIndexOfSQLFunction(List<ColumnExpression> columnExpressions) {
