 ...
 * @author xuejiaming
 */
public class DamengMathSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;
    private final MathMethodEnum mathMethodEnum;

    public DamengMathSQLFunction(List<ColumnExpression> columnExpressions, MathMethodEnum mathMethodEnum) {
    ...
    public String sqlSegment(TableAvailable defaultTable) {
        ...
        throw new UnsupportedOperationException("不支持当前函数DamengMathSQLFunction:"+ mathMethodEnum);
    }
