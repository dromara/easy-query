...
/**
 * create time 2023/10/19 08:52
 * 文件说明
 *
 * @author xuejiaming
 */
public class DamengSumSQLFunction extends SumSQLFunction {
    public DamengSumSQLFunction(List<ColumnExpression> columnExpressions) {
