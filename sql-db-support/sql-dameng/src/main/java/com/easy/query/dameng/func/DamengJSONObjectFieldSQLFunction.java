 ...
 * @author xuejiaming
 */
public class DamengJSONObjectFieldSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public DamengJSONObjectFieldSQLFunction(List<ColumnExpression> concatExpressions) {
