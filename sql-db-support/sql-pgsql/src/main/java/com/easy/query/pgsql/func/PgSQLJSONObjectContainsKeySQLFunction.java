 ...
 * @author xuejiaming
 */
public class PgSQLJSONObjectContainsKeySQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public PgSQLJSONObjectContainsKeySQLFunction(List<ColumnExpression> concatExpressions) {
