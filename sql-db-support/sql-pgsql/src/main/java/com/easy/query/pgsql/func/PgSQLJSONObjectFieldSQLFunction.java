 ...
 * @author xuejiaming
 */
public class PgSQLJSONObjectFieldSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public PgSQLJSONObjectFieldSQLFunction(List<ColumnExpression> concatExpressions) {
