...
import com.easy.query.test.mysql8.entity.bank.proxy.SysBankCardIntProxy;
...
@FieldNameConstants
@EasyAlias("bank_card")
public class SysBankCardInt implements ProxyEntityAvailable<SysBankCardInt, SysBankCardIntProxy>, Serializable {
