...
public class TopicProxy extends AbstractProxyEntity < TopicProxy, Topic > {
     ...
     * {@link Topic#getId}
     */
    public SQLStringColumn < TopicProxy, String> id(){
     ...
     * {@link Topic#getStars}
     */
    public SQLNumberColumn < TopicProxy, Integer> stars(){
     ...
     * {@link Topic#getTitle}
     */
    public SQLStringColumn < TopicProxy, String> title(){
     ...
     * {@link Topic#getAlias}
     */
    public SQLStringColumn < TopicProxy, String> alias(){
    return getStringColumn("alias", String.class);
}
