...
// * @author xuejiaming
// */
//public class DefaultEasyRedisProvider implements EasyCacheProvider {
...
//
//    public DefaultEasyRedisProvider(RedissonClient redissonClient, EasyQueryClient easyQueryClient, EasyCacheOption easyCacheOption) {
