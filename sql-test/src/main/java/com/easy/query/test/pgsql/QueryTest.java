...
public void query10() {
    ...
    public void testDraft9() {
        ...
        try {
            ...
            Draft7<Long, Long, Long, Long, Long, Long, Long> draft4 = entityQuery.queryable(BlogEntity.class)
                    .whereById(id)
                    .select(o -> Select.DRAFT.of(
                            SQLMathExpression.abs(o.createTime().duration(o.updateTime()).toDays()),
                            o.updateTime().duration(o.createTime()).toHours(),
                            o.updateTime().duration(o.createTime()).toMinutes(),
                            o.updateTime().duration(o.createTime()).toSeconds(),
                            o.createTime().duration(o.createTime().plusTime(1,TimeUnitEnum.DAYS)).toDays(),
                            o.createTime().duration(o.createTime().plusTime(2,TimeUnitEnum.SECONDS)).toSeconds(),
                            o.createTime().duration(o.createTime().plusTime(1,TimeUnitEnum.DAYS).plusTime(3,TimeUnitEnum.MINUTES)).toMinutes()
                    )).firstOrNull();
    ...
    public void testPartitionBy3(){
        ...
        Assert.assertNotNull(listenerContext.getJdbcExecuteAfterArg());
        JdbcExecuteAfterArg jdbcExecuteAfterArg = listenerContext.getJdbcExecuteAfterArg();
        Assert.assertEquals("SELECT t1.\"id\",t1.\"create_time\",t1.\"update_time\",t1.\"create_by\",t1.\"update_by\",t1.\"deleted\",t1.\"title\",t1.\"content\",t1.\"url\",t1.\"star\",t1.\"publish_time\",t1.\"score\",t1.\"status\",t1.\"order\",t1.\"is_top\",t1.\"top\",t1.\"__partition__column1\" AS \"__partition__column1\" FROM (SELECT t.\"id\",t.\"create_time\",t.\"update_time\",t.\"create_by\",t.\"update_by\",t.\"deleted\",t.\"title\",t.\"content\",t.\"url\",t.\"star\",t.\"publish_time\",t.\"score\",t.\"status\",t.\"order\",t.\"is_top\",t.\"top\",(RANK() OVER (PARTITION BY t.\"title\" ORDER BY t.\"create_time\" ASC)) AS \"__partition__column1\" FROM \"t_blog\" t WHERE t.\"deleted\" = ? AND t.\"create_time\" > ?) t1 WHERE t1.\"star\" > ? AND t1.\"__partition__column1\" < ?", jdbcExecuteAfterArg.getBeforeArg().getSql());
        Assert.assertEquals("false(Boolean),2020-01-01T01:01(LocalDateTime),1(Integer),2(Long)", EasySQLUtil.sqlParameterToString(jdbcExecuteAfterArg.getBeforeArg().getSqlParameters().get(0)));
        listenerContextManager.clear();
        for (Partition1<BlogEntity, Long> blogEntityLongPartition1 : list) {
    ...
    public void testPartitionBy7(){
        ...
        List<Partition1<BlogEntity, Integer>> list = entityQuery.queryable(BlogEntity.class)
                .where(b -> b.createTime().gt(LocalDateTime.of(2020, 1, 1, 1, 1)))
                .select(b -> Select.PARTITION.of(
                        b,
                    ...
                    partition.entityTable().star().gt(1);
                    partition.partitionColumn1().lt(2);
                }).toList();
        Assert.assertNotNull(listenerContext.getJdbcExecuteAfterArg());
        JdbcExecuteAfterArg jdbcExecuteAfterArg = listenerContext.getJdbcExecuteAfterArg();
        Assert.assertEquals("SELECT t1.\"id\",t1.\"create_time\",t1.\"update_time\",t1.\"create_by\",t1.\"update_by\",t1.\"deleted\",t1.\"title\",t1.\"content\",t1.\"url\",t1.\"star\",t1.\"publish_time\",t1.\"score\",t1.\"status\",t1.\"order\",t1.\"is_top\",t1.\"top\",t1.\"__partition__column1\" AS \"__partition__column1\" FROM (SELECT t.\"id\",t.\"create_time\",t.\"update_time\",t.\"create_by\",t.\"update_by\",t.\"deleted\",t.\"title\",t.\"content\",t.\"url\",t.\"star\",t.\"publish_time\",t.\"score\",t.\"status\",t.\"order\",t.\"is_top\",t.\"top\",(SUM(t.\"star\") OVER (PARTITION BY t.\"title\" ORDER BY t.\"create_time\" ASC)) AS \"__partition__column1\" FROM \"t_blog\" t WHERE t.\"deleted\" = ? AND t.\"create_time\" > ?) t1 WHERE t1.\"star\" > ? AND t1.\"__partition__column1\" < ?", jdbcExecuteAfterArg.getBeforeArg().getSql());
        ...
        listenerContextManager.clear();
        for (Partition1<BlogEntity, Integer> blogEntityLongPartition1 : list) {

            BlogEntity entity = blogEntityLongPartition1.getEntity();
            Assert.assertNotNull(entity);
            Integer partitionColumn1 = blogEntityLongPartition1.getPartitionColumn1();
            Assert.assertNotNull(partitionColumn1);
    ...
    public void testPartitionBy9(){
        ...
        List<Partition1<BlogEntity, BigDecimal>> list = entityQuery.queryable(BlogEntity.class)
                .where(b -> b.createTime().gt(LocalDateTime.of(2020, 1, 1, 1, 1)))
                .select(b -> Select.PARTITION.of(
                        b,
                    ...
                    partition.entityTable().star().gt(1);
                    partition.partitionColumn1().lt(BigDecimal.valueOf(2));
                }).toList();
        Assert.assertNotNull(listenerContext.getJdbcExecuteAfterArg());
        JdbcExecuteAfterArg jdbcExecuteAfterArg = listenerContext.getJdbcExecuteAfterArg();
        Assert.assertEquals("SELECT t1.\"id\",t1.\"create_time\",t1.\"update_time\",t1.\"create_by\",t1.\"update_by\",t1.\"deleted\",t1.\"title\",t1.\"content\",t1.\"url\",t1.\"star\",t1.\"publish_time\",t1.\"score\",t1.\"status\",t1.\"order\",t1.\"is_top\",t1.\"top\",t1.\"__partition__column1\" AS \"__partition__column1\" FROM (SELECT t.\"id\",t.\"create_time\",t.\"update_time\",t.\"create_by\",t.\"update_by\",t.\"deleted\",t.\"title\",t.\"content\",t.\"url\",t.\"star\",t.\"publish_time\",t.\"score\",t.\"status\",t.\"order\",t.\"is_top\",t.\"top\",(AVG(t.\"star\") OVER (PARTITION BY t.\"title\" ORDER BY t.\"create_time\" ASC)) AS \"__partition__column1\" FROM \"t_blog\" t WHERE t.\"deleted\" = ? AND t.\"create_time\" > ?) t1 WHERE t1.\"star\" > ? AND t1.\"__partition__column1\" < ?", jdbcExecuteAfterArg.getBeforeArg().getSql());
        ...
        listenerContextManager.clear();
        for (Partition1<BlogEntity, BigDecimal> blogEntityLongPartition1 : list) {

            BlogEntity entity = blogEntityLongPartition1.getEntity();
            Assert.assertNotNull(entity);
            BigDecimal partitionColumn1 = blogEntityLongPartition1.getPartitionColumn1();
            Assert.assertNotNull(partitionColumn1);
    ...
    public void testPartitionBy11(){
        ...
        Assert.assertNotNull(listenerContext.getJdbcExecuteAfterArg());
        JdbcExecuteAfterArg jdbcExecuteAfterArg = listenerContext.getJdbcExecuteAfterArg();
        Assert.assertEquals("SELECT t1.\"id\",t1.\"create_time\",t1.\"update_time\",t1.\"create_by\",t1.\"update_by\",t1.\"deleted\",t1.\"title\",t1.\"content\",t1.\"url\",t1.\"star\",t1.\"publish_time\",t1.\"score\",t1.\"status\",t1.\"order\",t1.\"is_top\",t1.\"top\",t1.\"__partition__column1\" AS \"__partition__column1\" FROM (SELECT t.\"id\",t.\"create_time\",t.\"update_time\",t.\"create_by\",t.\"update_by\",t.\"deleted\",t.\"title\",t.\"content\",t.\"url\",t.\"star\",t.\"publish_time\",t.\"score\",t.\"status\",t.\"order\",t.\"is_top\",t.\"top\",(MAX(t.\"star\") OVER (PARTITION BY t.\"title\" ORDER BY t.\"create_time\" ASC)) AS \"__partition__column1\" FROM \"t_blog\" t WHERE t.\"deleted\" = ? AND t.\"create_time\" > ?) t1 WHERE t1.\"star\" > ? AND t1.\"__partition__column1\" < ?", jdbcExecuteAfterArg.getBeforeArg().getSql());
        Assert.assertEquals("false(Boolean),2020-01-01T01:01(LocalDateTime),1(Integer),2(Integer)", EasySQLUtil.sqlParameterToString(jdbcExecuteAfterArg.getBeforeArg().getSqlParameters().get(0)));
        listenerContextManager.clear();
        for (Partition1<BlogEntity, Integer> blogEntityLongPartition1 : list) {
    ...
    public void testPartitionBy13(){
        ...
        Assert.assertNotNull(listenerContext.getJdbcExecuteAfterArg());
        JdbcExecuteAfterArg jdbcExecuteAfterArg = listenerContext.getJdbcExecuteAfterArg();
        Assert.assertEquals("SELECT t1.\"id\",t1.\"create_time\",t1.\"update_time\",t1.\"create_by\",t1.\"update_by\",t1.\"deleted\",t1.\"title\",t1.\"content\",t1.\"url\",t1.\"star\",t1.\"publish_time\",t1.\"score\",t1.\"status\",t1.\"order\",t1.\"is_top\",t1.\"top\",t1.\"__partition__column1\" AS \"__partition__column1\" FROM (SELECT t.\"id\",t.\"create_time\",t.\"update_time\",t.\"create_by\",t.\"update_by\",t.\"deleted\",t.\"title\",t.\"content\",t.\"url\",t.\"star\",t.\"publish_time\",t.\"score\",t.\"status\",t.\"order\",t.\"is_top\",t.\"top\",(MIN(t.\"star\") OVER (PARTITION BY t.\"title\" ORDER BY t.\"create_time\" ASC)) AS \"__partition__column1\" FROM \"t_blog\" t WHERE t.\"deleted\" = ? AND t.\"create_time\" > ?) t1 WHERE t1.\"star\" > ? AND t1.\"__partition__column1\" < ?", jdbcExecuteAfterArg.getBeforeArg().getSql());
        Assert.assertEquals("false(Boolean),2020-01-01T01:01(LocalDateTime),1(Integer),2(Integer)", EasySQLUtil.sqlParameterToString(jdbcExecuteAfterArg.getBeforeArg().getSqlParameters().get(0)));
        listenerContextManager.clear();
        for (Partition1<BlogEntity, Integer> blogEntityLongPartition1 : list) {
