...
import com.easy.query.api.proxy.select.extension.queryable2.override.AbstractOverrideProxyQueryable2;
...
public abstract class AbstractProxyQueryable2<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1, T2Proxy extends ProxyEntity<T2Proxy, T2>, T2>
        extends AbstractOverrideProxyQueryable2<T1Proxy, T1, T2Proxy, T2>
