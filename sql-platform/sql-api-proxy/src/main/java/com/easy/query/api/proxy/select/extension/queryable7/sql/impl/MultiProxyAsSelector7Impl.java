 ...
 * @author xuejiaming
 */
public class MultiProxyAsSelector7Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        TRProxy extends ProxyEntity<TRProxy, TR>, TR> implements MultiProxyAsSelector7<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy, T6Proxy, T7Proxy, TRProxy, TR> {
    ...
    public MultiProxyAsSelector7Impl(AsSelector asSelector, T1Proxy t, T2Proxy t1, T3Proxy t2, T4Proxy t3, T5Proxy t4, T6Proxy t5, T7Proxy t6, TRProxy trProxy) {
