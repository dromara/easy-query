...
import com.easy.query.api.proxy.select.extension.queryable8.override.AbstractOverrideProxyQueryable8;
...
public abstract class AbstractProxyQueryable8<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        implements ProxyQueryable8<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8> {
