 ...
 * @author xuejiaming
 */
public class ColumnFunctionComparableBooleanChainExpressionImpl<TProperty> implements ColumnFunctionComparableBooleanChainExpression<TProperty> {
    ...
    public ColumnFunctionComparableBooleanChainExpressionImpl(EntitySQLContext entitySQLContext, TableAvailable table, String property, Function<SQLFunc, SQLFunction> func) {
        this(entitySQLContext,table,property,func,Object.class);
    }
    public ColumnFunctionComparableBooleanChainExpressionImpl(EntitySQLContext entitySQLContext, TableAvailable table, String property, Function<SQLFunc, SQLFunction> func, Class<?> propType) {
