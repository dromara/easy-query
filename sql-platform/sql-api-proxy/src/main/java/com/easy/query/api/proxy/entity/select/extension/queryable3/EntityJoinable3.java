...
public interface EntityJoinable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4 extends ProxyEntityAvailable<T4,T4Proxy>> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> leftJoin(Class<T4> joinClass, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        T4Proxy t4Proxy = EntityQueryProxyManager.create(joinClass);
        return leftJoin(t4Proxy,on);
    }
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> leftJoin(T4Proxy t4Proxy, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> leftJoin(EntityQueryable<T4Proxy, T4> joinQueryable, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4 extends ProxyEntityAvailable<T4,T4Proxy>> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> rightJoin(Class<T4> joinClass, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        T4Proxy t4Proxy = EntityQueryProxyManager.create(joinClass);
        return rightJoin(t4Proxy,on);

    }
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> rightJoin(T4Proxy t4Proxy, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> rightJoin(EntityQueryable<T4Proxy, T4> joinQueryable, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        if(EasySQLExpressionUtil.useTableForJoin(joinQueryable.getSQLEntityExpressionBuilder())){
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4 extends ProxyEntityAvailable<T4,T4Proxy>> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> innerJoin(Class<T4> joinClass, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        T4Proxy t4Proxy = EntityQueryProxyManager.create(joinClass);
        return innerJoin(t4Proxy,on);
    }

    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> innerJoin(T4Proxy t4Proxy, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> innerJoin(EntityQueryable<T4Proxy, T4> joinQueryable, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        if(EasySQLExpressionUtil.useTableForJoin(joinQueryable.getSQLEntityExpressionBuilder())){
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4 extends ProxyEntityAvailable<T4,T4Proxy>> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> crossJoin(Class<T4> joinClass, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        T4Proxy t4Proxy = EntityQueryProxyManager.create(joinClass);
        return crossJoin(t4Proxy,on);
    }

    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> crossJoin(T4Proxy t4Proxy, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        ClientQueryable4<T1, T2, T3, T4> entityQueryable4 = getClientQueryable3().crossJoin(t4Proxy.getEntityClass(), (t, t1, t2, t3) -> {
            get1Proxy().getEntitySQLContext()._where(t.getFilter(),()->{
                on.apply(get1Proxy(), get2Proxy(), get3Proxy(), t4Proxy.create(t3.getTable(),get1Proxy().getEntitySQLContext()));
            });
        });
    ...
    default <T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> crossJoin(EntityQueryable<T4Proxy, T4> joinQueryable, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> on) {
        if(EasySQLExpressionUtil.useTableForJoin(joinQueryable.getSQLEntityExpressionBuilder())){
            return crossJoin(joinQueryable.get1Proxy(),on);
        }
        ClientQueryable4<T1, T2, T3, T4> entityQueryable4 = getClientQueryable3().crossJoin(joinQueryable.getClientQueryable(), (t, t1, t2, t3) -> {
            get1Proxy().getEntitySQLContext()._where(t.getFilter(),()->{
                on.apply(get1Proxy(), get2Proxy(), get3Proxy(), joinQueryable.get1Proxy().create(t3.getTable(), get1Proxy().getEntitySQLContext()));
            });
        });
