 ...
 * @author xuejiaming
 */
public class Draft10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends AbstractDraft implements ProxyEntityAvailable<Draft10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>, Draft10Proxy<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> {
    private T1 value1;
    private T2 value2;
    private T3 value3;
    private T4 value4;
    ...
    public void setValue10(T10 value10) {
    ...
    @Override
    public Class<Draft10Proxy<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> proxyTableClass() {
        return EasyObjectUtil.typeCastNullable(Draft10Proxy.class);
    }
}