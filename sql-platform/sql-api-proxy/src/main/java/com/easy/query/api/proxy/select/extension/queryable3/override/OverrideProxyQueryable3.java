...
public interface OverrideProxyQueryable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1, T2Proxy extends ProxyEntity<T2Proxy, T2>, T2, T3Proxy extends ProxyEntity<T3Proxy, T3>, T3> extends ProxyQueryable<T1Proxy, T1>, ProxyQueryable3Available<T1Proxy, T1, T2Proxy, T2,T3Proxy,T3> {
    ...
    @Override
    default ProxyQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where(SQLExpression1<MultiProxyFilter1<T1Proxy>> whereExpression) {
        return where(true, whereExpression);
    }

    @Override
    ProxyQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where(boolean condition, SQLExpression1<MultiProxyFilter1<T1Proxy>> whereExpression);
