...
public abstract class AbstractOverrideEntityQueryable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1, T2Proxy extends ProxyEntity<T2Proxy, T2>, T2, T3Proxy extends ProxyEntity<T3Proxy, T3>, T3> extends AbstractEntityQueryable<T1Proxy, T1> implements EntityQueryable3Available<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> {
    ...
    @Override
    public EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> orderBy(boolean condition, SQLFuncExpression1<T1Proxy, SQLOrderSelect> selectExpression) {
    ...
    @Override
    public EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where(boolean condition, SQLFuncExpression1<T1Proxy, SQLPredicate> whereExpression) {
        super.where(condition, whereExpression);
        return getQueryable3();
    }

    @Override
    public EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> groupBy(boolean condition, SQLFuncExpression1<T1Proxy, SQLGroupSelect> selectExpression) {
        super.groupBy(condition, selectExpression);
        return getQueryable3();
    }

    @Override
    public EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> having(boolean condition, SQLFuncExpression1<T1Proxy, SQLAggregatePredicate> predicateExpression) {
        super.having(condition, predicateExpression);
        return getQueryable3();
    }

//    @Override
//    public <TPropertyProxy extends ProxyEntity<TPropertyProxy, TProperty>, TProperty> EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> include(boolean condition, SQLFuncExpression2<ProxyNavigateInclude<T1>,T1Proxy, EntityQueryable<TPropertyProxy, TProperty>> navigateIncludeSQLExpression) {
...
//    }
    ...
    @Override
    public EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> queryLargeColumn(boolean queryLarge) {
