...
public interface ProxyColumnConfigurer<TProxy extends ProxyEntity<TProxy, T>,T> {
    ...
    default <TProperty> ProxyColumnConfigurer<TProxy,T> column(SQLColumn<TProxy,TProperty> property, String sqlSegment, SQLActionExpression2<SQLNativeProxyExpressionContext, SQLParameter> contextConsume){
