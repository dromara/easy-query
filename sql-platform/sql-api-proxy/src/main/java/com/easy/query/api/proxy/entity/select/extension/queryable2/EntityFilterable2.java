...
public interface EntityFilterable2<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1, T2Proxy extends ProxyEntity<T2Proxy, T2>, T2> extends ClientEntityQueryable2Available<T1, T2>, EntityQueryable2Available<T1Proxy, T1, T2Proxy, T2> {
    ...
    default EntityQueryable2<T1Proxy, T1, T2Proxy, T2> whereMerge(SQLFuncExpression1<Tuple2<T1Proxy, T2Proxy>, SQLPredicateExpression> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default EntityQueryable2<T1Proxy, T1, T2Proxy, T2> whereMerge(boolean condition, SQLFuncExpression1<Tuple2<T1Proxy, T2Proxy>, SQLPredicateExpression> whereExpression) {
