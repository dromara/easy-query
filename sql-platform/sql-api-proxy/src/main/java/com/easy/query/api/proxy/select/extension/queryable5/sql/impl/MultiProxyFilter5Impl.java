 ...
 * @author xuejiaming
 */
public class MultiProxyFilter5Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        T2Proxy extends ProxyEntity<T2Proxy, T2>, T2,
        T3Proxy extends ProxyEntity<T3Proxy, T3>, T3,
        T4Proxy extends ProxyEntity<T4Proxy, T4>, T4,
        T5Proxy extends ProxyEntity<T5Proxy, T5>, T5> implements MultiProxyFilter5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy> {
    ...
    public MultiProxyFilter5Impl(Filter filter, T1Proxy t, T2Proxy t1, T3Proxy t2, T4Proxy t3, T5Proxy t4) {
        this.filter = filter;
        this.t = t;
        this.t1 = t1;
        this.t2 = t2;
