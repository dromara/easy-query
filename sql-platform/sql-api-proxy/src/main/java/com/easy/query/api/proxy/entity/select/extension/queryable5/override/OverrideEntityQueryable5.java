...
public interface OverrideEntityQueryable5<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    @Override
    default EntityQueryable5<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5> groupByExpression(SQLFuncExpression1<T1Proxy, SQLGroupByExpression> selectExpression) {
        return groupByExpression(true, selectExpression);
    }

    @Override
    EntityQueryable5<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5> groupByExpression(boolean condition, SQLFuncExpression1<T1Proxy, SQLGroupByExpression> selectExpression);
