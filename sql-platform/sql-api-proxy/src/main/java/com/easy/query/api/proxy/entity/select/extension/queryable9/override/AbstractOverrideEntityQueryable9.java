...
public abstract class AbstractOverrideEntityQueryable9<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    @Override
    public EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> orderBy(boolean condition, SQLActionExpression1<T1Proxy> selectExpression) {
    ...
    @Override
    public EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> where(boolean condition, SQLActionExpression1<T1Proxy> whereExpression) {
        super.where(condition, whereExpression);
        return getQueryable9();
    }
    @Override
    public EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> having(boolean condition, SQLActionExpression1<T1Proxy> predicateExpression) {
...
//    }
    ...
    @Override
    public EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> configure(SQLActionExpression1<ContextConfigurer> configurer) {
    ...
    public <TR2Proxy extends ProxyEntity<TR2Proxy, TR2>, TR2 extends ProxyEntityAvailable<TR2, TR2Proxy>> EntityQueryable2<T1Proxy, T1, TR2Proxy, TR2> leftJoin(Class<TR2> joinClass, SQLActionExpression2<T1Proxy, TR2Proxy> on) {
        throw new UnsupportedOperationException("plz use ten-parameter lambda expression (a, b, c, d, e, f, g, h, i, j) -> {}");
    }
