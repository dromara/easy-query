...
public abstract class AbstractOverrideProxyQueryable10<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        T10Proxy extends ProxyEntity<T10Proxy, T10>, T10> implements ProxyQueryable10<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9, T10Proxy, T10> {

    protected final QueryRuntimeContext runtimeContext;
    protected final ClientQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> entityQueryable;

    public AbstractOverrideProxyQueryable10(ClientQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> entityQueryable) {
    ...
    @Override
    public ProxyQueryable10<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9, T10Proxy, T10> filterConfigure(ValueFilter valueFilter) {
