...
public interface ProxyFilterable2<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
     ...
     */
    default ProxyQueryable2<T1Proxy, T1, T2Proxy, T2> where(SQLPredicateExpression... sqlPredicates) {
     ...
     * @return 返回当前查询queryable
     */
    default ProxyQueryable2<T1Proxy, T1, T2Proxy, T2> where(boolean condition, SQLPredicateExpression... sqlPredicates){
        if (condition) {
