 ...
 * @author xuejiaming
 */
public abstract class AbstractEntityQueryable9<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        extends AbstractOverrideEntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9>
        implements EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> {
    ...
    public AbstractEntityQueryable9(T1Proxy t1Proxy, T2Proxy t2Proxy, T3Proxy t3Proxy, T4Proxy t4Proxy, T5Proxy t5Proxy, T6Proxy t6Proxy, T7Proxy t7Proxy, T8Proxy t8Proxy, T9Proxy t9Proxy, ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> entityQueryable) {
    ...
    @Override
    public EntityQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> getQueryable9() {
        return this;
    }
}
