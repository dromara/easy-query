 ...
 * @author xuejiaming
 */
public class MultiProxyGroupSelector8Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        T8Proxy extends ProxyEntity<T8Proxy, T8>, T8> implements MultiProxyGroupSelector8<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy, T6Proxy, T7Proxy, T8Proxy> {
    ...
    public MultiProxyGroupSelector8Impl(GroupSelector groupSelector, T1Proxy t, T2Proxy t1, T3Proxy t2, T4Proxy t3, T5Proxy t4, T6Proxy t5, T7Proxy t6, T8Proxy t7) {
