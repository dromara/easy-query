...
public interface EntityFilterable5<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable5<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5> where(SQLActionExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy> whereExpression) {
        return where(true, whereExpression);
    }

    default EntityQueryable5<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5> where(boolean condition, SQLActionExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy> whereExpression) {
        if (condition) {
