...
public interface OverrideEntityQueryable2<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1, T2Proxy extends ProxyEntity<T2Proxy, T2>, T2> extends EntityQueryable<T1Proxy, T1>, EntityQueryable2Available<T1Proxy, T1, T2Proxy, T2> {
    ...
    @Override
    default EntityQueryable2<T1Proxy, T1, T2Proxy, T2> groupByExpression(SQLFuncExpression1<T1Proxy, SQLGroupByExpression> selectExpression) {
        return groupByExpression(true, selectExpression);
    }

    @Override
    EntityQueryable2<T1Proxy, T1, T2Proxy, T2> groupByExpression(boolean condition, SQLFuncExpression1<T1Proxy, SQLGroupByExpression> selectExpression);
