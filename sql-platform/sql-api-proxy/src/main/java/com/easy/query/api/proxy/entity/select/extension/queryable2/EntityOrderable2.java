...
public interface EntityOrderable2<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable2<T1Proxy, T1, T2Proxy, T2> orderByMerge(SQLFuncExpression1<Tuple2<T1Proxy, T2Proxy>, SQLOrderByExpression> selectExpression) {
        return orderByMerge(true, selectExpression);
    }

    default EntityQueryable2<T1Proxy, T1, T2Proxy, T2> orderByMerge(boolean condition, SQLFuncExpression1<Tuple2<T1Proxy, T2Proxy>, SQLOrderByExpression> selectExpression) {
