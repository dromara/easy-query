...
public interface EntityHavingable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> havingMerge(SQLFuncExpression1<MergeTuple3<T1Proxy, T2Proxy, T3Proxy>, SQLAggregatePredicateExpression> predicateExpression) {
        return havingMerge(true, predicateExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> havingMerge(boolean condition, SQLFuncExpression1<MergeTuple3<T1Proxy, T2Proxy, T3Proxy>, SQLAggregatePredicateExpression> predicateExpression) {
        return having(condition, (t1, t2, t3) -> {
            return predicateExpression.apply(new MergeTuple3<>(t1, t2, t3));
        });
    }
