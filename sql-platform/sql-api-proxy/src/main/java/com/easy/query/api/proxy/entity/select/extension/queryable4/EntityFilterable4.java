...
public interface EntityFilterable4<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> where(SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> whereExpression) {
        return where(true, whereExpression);
    }

    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> where(boolean condition, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> whereExpression) {
        if (condition) {
    ...
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> whereMerge(SQLActionExpression1<MergeTuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> whereMerge(boolean condition, SQLActionExpression1<MergeTuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>> whereExpression) {
