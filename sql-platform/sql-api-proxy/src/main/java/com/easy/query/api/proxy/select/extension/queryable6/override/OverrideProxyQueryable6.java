...
public interface OverrideProxyQueryable6<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    @Override
    default ProxyQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> where(SQLExpression1<MultiProxyFilter1<T1Proxy>> whereExpression) {
        return where(true, whereExpression);
    }

    @Override
    ProxyQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> where(boolean condition, SQLExpression1<MultiProxyFilter1<T1Proxy>> whereExpression);
