 ...
 * @author xuejiaming
 */
public class MultiProxyAggregateFilter3Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        T2Proxy extends ProxyEntity<T2Proxy, T2>, T2,
        T3Proxy extends ProxyEntity<T3Proxy, T3>, T3> implements MultiProxyAggregateFilter3<T1Proxy, T2Proxy, T3Proxy> {
    ...
    public MultiProxyAggregateFilter3Impl(AggregateFilter aggregateFilter, T1Proxy t, T2Proxy t1, T3Proxy t2) {
