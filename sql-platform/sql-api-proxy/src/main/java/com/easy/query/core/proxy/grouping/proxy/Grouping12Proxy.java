 ...
 * @author xuejiaming
 */
public class Grouping12Proxy<TKey1Proxy extends PropTypeColumn<TKey1>, TKey1,
        ...
        TSourceProxy>
        extends AbstractGroupingProxy<Grouping12Proxy<TKey1Proxy, TKey1, TKey2Proxy, TKey2, TKey3Proxy, TKey3, TKey4Proxy, TKey4, TKey5Proxy, TKey5, TKey6Proxy, TKey6, TKey7Proxy, TKey7, TKey8Proxy, TKey8, TKey9Proxy, TKey9, TKey10Proxy, TKey10,TKey11Proxy, TKey11,TKey12Proxy, TKey12, TSourceProxy>,
        Grouping12<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6, TKey7, TKey8, TKey9, TKey10, TKey11, TKey12>, TSourceProxy> {

    private static final Class<Grouping12> entityClass = Grouping12.class;
    ...
    public Grouping12Proxy(TKey1Proxy k1, TKey2Proxy k2, TKey3Proxy k3, TKey4Proxy k4, TKey5Proxy k5, TKey6Proxy k6, TKey7Proxy k7, TKey8Proxy k8, TKey9Proxy k9, TKey10Proxy k10, TKey11Proxy k11, TKey12Proxy k12, TSourceProxy tSourceProxy) {
        super(tSourceProxy);
        this.k1 = k1;
        this.k2 = k2;
        this.k3 = k3;
    ...
    @Override
    public Class<Grouping12<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6, TKey7, TKey8, TKey9, TKey10, TKey11, TKey12>> getEntityClass() {
