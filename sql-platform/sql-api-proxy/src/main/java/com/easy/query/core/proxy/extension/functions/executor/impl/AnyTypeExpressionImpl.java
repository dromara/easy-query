 ...
 * @author xuejiaming
 */
public class AnyTypeExpressionImpl<TProperty> implements AnyTypeExpression<TProperty> {
    ...
    public AnyTypeExpressionImpl(EntitySQLContext entitySQLContext, TableAvailable table, String property, Function<SQLFunc, SQLFunction> func) {
        this(entitySQLContext, table, property, func, Object.class);
    }

    public AnyTypeExpressionImpl(EntitySQLContext entitySQLContext, TableAvailable table, String property, Function<SQLFunc, SQLFunction> func, Class<?> propType) {
