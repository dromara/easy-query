...
public interface EntityGroupable2<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable2<T1Proxy,T1,T2Proxy,T2> groupBy(SQLFuncExpression2<T1Proxy, T2Proxy, SQLGroupByExpression> selectExpression) {
        return groupBy(true,selectExpression);
    }

    default EntityQueryable2<T1Proxy,T1,T2Proxy,T2> groupBy(boolean condition, SQLFuncExpression2<T1Proxy, T2Proxy, SQLGroupByExpression> selectExpression) {
        if (condition) {
    ...
    default EntityQueryable2<T1Proxy,T1,T2Proxy,T2> groupByMerge(SQLFuncExpression1<MergeTuple2<T1Proxy, T2Proxy>, SQLGroupByExpression> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default EntityQueryable2<T1Proxy,T1,T2Proxy,T2> groupByMerge(boolean condition, SQLFuncExpression1<MergeTuple2<T1Proxy, T2Proxy>, SQLGroupByExpression> selectExpression) {
