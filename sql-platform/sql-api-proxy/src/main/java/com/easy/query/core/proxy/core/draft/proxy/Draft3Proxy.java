 ...
 * @author xuejiaming
 */
public class Draft3Proxy<T1,T2,T3> extends AbstractProxyEntity<Draft3Proxy<T1,T2,T3>, Draft3<T1,T2,T3>> {
     ...
     */
    public SQLColumn<Draft3Proxy<T1,T2,T3>, T1> value1() {
        return get("value1");
    }
     ...
     */
    public SQLColumn<Draft3Proxy<T1,T2,T3>, T2> value2() {
        return get("value2");
    }
    /**
     * {@link Draft3#getValue3()}
     */
    public SQLColumn<Draft3Proxy<T1,T2,T3>, T3> value3() {
        return get("value3");
    }
