...
public class Draft6Proxy<T1,T2,T3,T4,T5,T6> extends AbstractDraftProxy<Draft6Proxy<T1,T2,T3,T4,T5,T6>, Draft6<T1,T2,T3,T4,T5,T6>> {
     ...
     */
    public SQLAnyColumn<Draft6Proxy<T1,T2,T3,T4,T5,T6>, T1> value1() {
