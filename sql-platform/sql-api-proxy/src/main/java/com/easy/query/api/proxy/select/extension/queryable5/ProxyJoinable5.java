...
import com.easy.query.api.proxy.select.extension.queryable5.join.EasyProxyJoinOnQueryable6;
import com.easy.query.api.proxy.select.extension.queryable5.join.ProxyJoinOnQueryable6;
...
public interface ProxyJoinable5<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyJoinOnQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> leftJoin(T6Proxy joinProxy) {
        ...
        ClientQueryable6<T1, T2, T3, T4, T5, T6> queryable = sqlEntityExpressionBuilder.getRuntimeContext().getSQLClientApiFactory().createQueryable6(t1Proxy.getEntityClass(), t2Proxy.getEntityClass(), t3Proxy.getEntityClass(), t4Proxy.getEntityClass(), t5Proxy.getEntityClass(), joinProxy.getEntityClass(), MultiTableTypeEnum.LEFT_JOIN, sqlEntityExpressionBuilder);
        return new EasyProxyJoinOnQueryable6<>(t1Proxy, t2Proxy, t3Proxy, t4Proxy, t5Proxy, joinProxy, queryable);
    }

    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyJoinOnQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> leftJoin(ProxyQueryable<T6Proxy, T6> joinQueryable) {

        ClientQueryable<T6> joinClientQueryable = joinQueryable.getClientQueryable();
        ClientQueryable<T6> selectAllTQueryable = EasySQLExpressionUtil.cloneAndSelectAllQueryable(joinClientQueryable);
        T1Proxy t1Proxy = get1Proxy();
        T2Proxy t2Proxy = get2Proxy();
        T3Proxy t3Proxy = get3Proxy();
        T4Proxy t4Proxy = get4Proxy();
        ...
        ClientQueryable6<T1, T2, T3, T4, T5, T6> queryable = sqlEntityExpressionBuilder.getRuntimeContext().getSQLClientApiFactory().createQueryable6(t1Proxy.getEntityClass(), t2Proxy.getEntityClass(), t3Proxy.getEntityClass(), t4Proxy.getEntityClass(), t5Proxy.getEntityClass(), selectAllTQueryable, MultiTableTypeEnum.LEFT_JOIN, sqlEntityExpressionBuilder);
        return new EasyProxyJoinOnQueryable6<>(t1Proxy, t2Proxy, t3Proxy, t4Proxy, t5Proxy, joinQueryable.get1Proxy(), queryable);
    }

    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyJoinOnQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> innerJoin(T6Proxy joinProxy) {
        T1Proxy t1Proxy = get1Proxy();
        T2Proxy t2Proxy = get2Proxy();
        T3Proxy t3Proxy = get3Proxy();
        T4Proxy t4Proxy = get4Proxy();
    ...
    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyJoinOnQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> innerJoin(ProxyQueryable<T6Proxy, T6> joinQueryable) {
    ...
    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyJoinOnQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> rightJoin(T6Proxy joinProxy) {
        T1Proxy t1Proxy = get1Proxy();
        T2Proxy t2Proxy = get2Proxy();
        T3Proxy t3Proxy = get3Proxy();
        T4Proxy t4Proxy = get4Proxy();
    ...
    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyJoinOnQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> rightJoin(ProxyQueryable<T6Proxy, T6> joinQueryable) {
    ...
    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> leftJoin(T6Proxy joinProxy, SQLExpression1<MultiProxyFilter6<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy, T6Proxy>> on) {
        ClientQueryable6<T1, T2, T3, T4, T5, T6> entityQueryable6 = getClientQueryable5().leftJoin(joinProxy.getEntityClass(), (t, t1, t2, t3, t4, t5) -> {
            on.apply(new MultiProxyFilter6Impl<>(t.getFilter(), get1Proxy(), get2Proxy(), get3Proxy(), get4Proxy(), get5Proxy(), joinProxy.create(t5.getTable())));
        });
    ...
    default <T6Proxy extends ProxyEntity<T6Proxy, T6>, T6> ProxyQueryable6<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6> leftJoin(ProxyQueryable<T6Proxy, T6> joinQueryable, SQLExpression1<MultiProxyFilter6<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy, T6Proxy>> on) {
        ClientQueryable6<T1, T2, T3, T4, T5, T6> entityQueryable6 = getClientQueryable5().leftJoin(joinQueryable.getClientQueryable(), (t, t1, t2, t3, t4, t5) -> {
            on.apply(new MultiProxyFilter6Impl<>(t.getFilter(), get1Proxy(), get2Proxy(), get3Proxy(), get4Proxy(), get5Proxy(), joinQueryable.get1Proxy().create(t5.getTable())));
        });
