...
import com.easy.query.api.proxy.select.extension.queryable3.sql.MultiProxyFilter3Impl;
...
public interface ProxyFilterable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default ProxyQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where3(SQLExpression1<MultiProxyFilter3<T1Proxy, T2Proxy, T3Proxy>> whereExpression) {
        return where3(true,whereExpression);
    }

    default ProxyQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where3(boolean condition, SQLExpression1<MultiProxyFilter3<T1Proxy, T2Proxy, T3Proxy>> whereExpression) {
        if (condition) {
