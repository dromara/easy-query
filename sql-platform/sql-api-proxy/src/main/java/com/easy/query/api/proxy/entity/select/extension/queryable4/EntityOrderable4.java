...
public interface EntityOrderable4<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> orderBy(SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> selectExpression) {
        return orderBy(true, selectExpression);
    }

    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> orderBy(boolean condition, SQLActionExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> selectExpression) {
        if (condition) {
    ...
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> orderByMerge(SQLActionExpression1<MergeTuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>> selectExpression) {
        return orderByMerge(true, selectExpression);
    }

    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> orderByMerge(boolean condition, SQLActionExpression1<MergeTuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>> selectExpression) {
