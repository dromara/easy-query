 ...
 * @author xuejiaming
 */
public class MultiProxyGroupSelector9Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        T9Proxy extends ProxyEntity<T9Proxy, T9>, T9> implements MultiProxyGroupSelector9<T1Proxy, T2Proxy, T3Proxy, T4Proxy, T5Proxy, T6Proxy, T7Proxy, T8Proxy, T9Proxy> {
    ...
    public MultiProxyGroupSelector9Impl(GroupSelector groupSelector, T1Proxy t, T2Proxy t1, T3Proxy t2, T4Proxy t3, T5Proxy t4, T6Proxy t5, T7Proxy t6, T8Proxy t7, T9Proxy t8) {
