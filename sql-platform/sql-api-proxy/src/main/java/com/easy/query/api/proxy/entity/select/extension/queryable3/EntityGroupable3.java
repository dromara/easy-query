...
public interface EntityGroupable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> groupBy(SQLFuncExpression3<T1Proxy, T2Proxy, T3Proxy, SQLGroupSelect> selectExpression) {
        return groupBy(true, selectExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> groupBy(boolean condition, SQLFuncExpression3<T1Proxy, T2Proxy, T3Proxy, SQLGroupSelect> selectExpression) {
        if (condition) {
            getClientQueryable3().groupBy((selector1, selector2, selector3) -> {
                SQLGroupSelect sqlGroupSelect = selectExpression.apply(get1Proxy(), get2Proxy(), get3Proxy());
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> groupByMerge(SQLFuncExpression1<Tuple3<T1Proxy, T2Proxy, T3Proxy>,SQLGroupSelect> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> groupByMerge(boolean condition, SQLFuncExpression1<Tuple3<T1Proxy, T2Proxy, T3Proxy>,SQLGroupSelect> selectExpression) {
