 ...
 * @author xuejiaming
 */
public class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> extends AbstractDraft implements ProxyEntityAvailable<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>, Tuple8Proxy<T1, T2, T3, T4, T5, T6, T7, T8>> {
    private T1 value1;
    private T2 value2;
    private T3 value3;
    private T4 value4;
