 ...
 * @author xuejiaming
 */
public class MultiProxyAsSelector2Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        T2Proxy extends ProxyEntity<T2Proxy, T2>, T2,
        TRProxy extends ProxyEntity<TRProxy, TR>, TR> implements MultiProxyAsSelector2<T1Proxy, T2Proxy, TRProxy, TR> {
    ...
    public MultiProxyAsSelector2Impl(AsSelector asSelector, T1Proxy t, T2Proxy t1, TRProxy trProxy) {
