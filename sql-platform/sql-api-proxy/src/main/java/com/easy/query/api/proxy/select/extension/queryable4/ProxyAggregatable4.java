...
public interface ProxyAggregatable4<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default <TMember extends Number> BigDecimal sumBigDecimalOrDefault(SQLFuncExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy, SQLColumn<TMember>> columnSelectorExpression, BigDecimal def) {
        SQLColumn<TMember> memberSQLColumn = columnSelectorExpression.apply(getProxy(), get2Proxy(), get3Proxy(), get4Proxy());
        ColumnFunction sumFunction = getRuntimeContext().getColumnFunctionFactory().createSumFunction(false);
        List<TMember> result = getClientQueryable4().selectAggregateList(memberSQLColumn.getTable(), sumFunction, memberSQLColumn.value(), null);
    ...
    default <TMember> TMember maxOrDefault(SQLFuncExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy, SQLColumn<TMember>> columnSelectorExpression, TMember def) {
        ...
        List<TMember> result = getClientQueryable4().selectAggregateList(memberSQLColumn.getTable(), maxFunction, memberSQLColumn.value(), null);
        return EasyCollectionUtil.firstOrDefault(result, def);
    }
    ...
    default <TMember> TMember minOrDefault(SQLFuncExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy, SQLColumn<TMember>> columnSelectorExpression, TMember def) {
        ...
        List<TMember> result = getClientQueryable4().selectAggregateList(memberSQLColumn.getTable(), minFunction, memberSQLColumn.value(), null);
        return EasyCollectionUtil.firstOrDefault(result, def);
    }
    ...
    default <TMember extends Number, TResult extends Number> TResult avgOrDefault(SQLFuncExpression4<T1Proxy, T2Proxy, T3Proxy, T4Proxy, SQLColumn<TMember>> columnSelectorExpression, TResult def, Class<TResult> resultClass) {
        ...
        List<TResult> result = getClientQueryable4().selectAggregateList(memberSQLColumn.getTable(), avgFunction, memberSQLColumn.value(), resultClass);
        return EasyCollectionUtil.firstOrDefault(result, def);
    }
     ...
     * @return
     */
    default <TMember extends Number> BigDecimal sumBigDecimalOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return sumBigDecimalOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }


    default <TMember extends Number> BigDecimal sumBigDecimalOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, BigDecimal def) {
        return sumBigDecimalOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember extends Number> TMember sumOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return sumOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }

    default <TMember extends Number> TMember sumOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, TMember def) {
        return sumOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember> TMember maxOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return maxOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }

    default <TMember> TMember maxOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, TMember def) {
        return maxOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember> TMember minOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return minOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }

    default <TMember> TMember minOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, TMember def) {
        return minOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember extends Number> Double avgOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return avgOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }

    default <TMember extends Number> BigDecimal avgBigDecimalOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return avgBigDecimalOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }

    default <TMember extends Number> Float avgFloatOrNullMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression) {
        return avgFloatOrNull((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        });
    }

    default <TMember extends Number> Double avgOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, Double def) {
        return avgOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember extends Number> BigDecimal avgBigDecimalOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, BigDecimal def) {
        return avgBigDecimalOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember extends Number> Float avgFloatOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, Float def) {
        return avgFloatOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def);
    }

    default <TMember extends Number, TResult extends Number> TResult avgOrDefaultMerge(SQLFuncExpression1<Tuple4<T1Proxy, T2Proxy, T3Proxy, T4Proxy>, SQLColumn<TMember>> columnSelectorExpression, TResult def, Class<TResult> resultClass) {
        return avgOrDefault((t, t1, t2, t4) -> {
            return columnSelectorExpression.apply(new Tuple4<>(t, t1, t2, t4));
        }, def, resultClass);
    }
