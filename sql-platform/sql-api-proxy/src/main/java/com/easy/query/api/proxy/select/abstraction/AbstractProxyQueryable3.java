...
public abstract class AbstractProxyQueryable3<T1Proxy extends ProxyQuery<T1Proxy, T1>, T1, T2Proxy extends ProxyQuery<T2Proxy, T2>, T2, T3Proxy extends ProxyQuery<T3Proxy, T3>, T3>
    ...
    @Override
    public <T4Proxy extends ProxyQuery<T4Proxy, T4>, T4> ProxyQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> leftJoin(T4Proxy t4Proxy, SQLExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, ProxyFilter> on) {
        return null;
    }

    @Override
    public <T4Proxy extends ProxyQuery<T4Proxy, T4>, T4> ProxyQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> leftJoin(ProxyQueryable<T4Proxy, T4> joinQueryable, SQLExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, ProxyFilter> on) {
        return null;
    }

    @Override
    public <T4Proxy extends ProxyQuery<T4Proxy, T4>, T4> ProxyQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> rightJoin(T4Proxy t4Proxy, SQLExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, ProxyFilter> on) {
        return null;
    }

    @Override
    public <T4Proxy extends ProxyQuery<T4Proxy, T4>, T4> ProxyQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> rightJoin(ProxyQueryable<T4Proxy, T4> joinQueryable, SQLExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, ProxyFilter> on) {
        return null;
    }

    @Override
    public <T4Proxy extends ProxyQuery<T4Proxy, T4>, T4> ProxyQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> innerJoin(T4Proxy t4Proxy, SQLExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, ProxyFilter> on) {
        return null;
    }

    @Override
    public <T4Proxy extends ProxyQuery<T4Proxy, T4>, T4> ProxyQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> innerJoin(ProxyQueryable<T4Proxy, T4> joinQueryable, SQLExpression5<T1Proxy, T2Proxy, T3Proxy, T4Proxy, ProxyFilter> on) {
        return null;
    }

    @Override
    public ProxyQueryable3<T1Proxy, T1, T2Proxy, T2,T3Proxy,T3> where(boolean condition, SQLExpression2<T1Proxy, ProxyFilter> whereExpression) {
    ...
    @Override
    public <TRProxy extends ProxyQuery<TRProxy, TR>, TR> ProxyQueryable<TRProxy, TR> select(TRProxy trProxy, SQLExpression4<T1Proxy, T2Proxy,T3Proxy, ProxyAsSelector<TRProxy, TR>> selectExpression) {
        ClientQueryable<TR> select = entityQueryable3.select(trProxy.getEntityClass(), (selector1, selector2, selector3) -> {
            selectExpression.apply(get1Proxy(), get2Proxy(),get3Proxy(), new ProxyAsSelectorImpl<>(selector3.getAsSelector()));
        });
    ...
    @Override
    public ProxyQueryable3<T1Proxy, T1, T2Proxy, T2,T3Proxy,T3> orderByAsc(boolean condition, SQLExpression2<T1Proxy, ProxyOrderSelector> selectExpression) {
        super.orderByAsc(condition, selectExpression);
        return this;
    }

    @Override
    public ProxyQueryable3<T1Proxy, T1, T2Proxy, T2,T3Proxy,T3> orderByDesc(boolean condition, SQLExpression2<T1Proxy, ProxyOrderSelector> selectExpression) {
        super.orderByDesc(condition, selectExpression);
        return this;
    }

    @Override
    public ProxyQueryable3<T1Proxy, T1, T2Proxy, T2,T3Proxy,T3> groupBy(boolean condition, SQLExpression2<T1Proxy, ProxyGroupSelector> selectExpression) {
        super.groupBy(condition, selectExpression);
        return this;
    }

    @Override
    public ProxyQueryable3<T1Proxy, T1, T2Proxy, T2,T3Proxy,T3> having(boolean condition, SQLExpression2<T1Proxy, ProxyAggregateFilter> aggregateFilterSQLExpression) {
