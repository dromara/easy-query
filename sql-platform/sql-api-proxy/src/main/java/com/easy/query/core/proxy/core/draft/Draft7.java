 ...
 * @author xuejiaming
 */
public class Draft7<T1, T2, T3, T4, T5, T6, T7> extends AbstractDraft implements ProxyEntityAvailable<Draft7<T1, T2, T3, T4, T5, T6, T7>, Draft7Proxy<T1, T2, T3, T4, T5, T6, T7>> {
    private T1 value1;
    private T2 value2;
    private T3 value3;
    private T4 value4;
    ...
    @Override
    public Class<Draft7Proxy<T1, T2, T3, T4, T5, T6, T7>> proxyTableClass() {
        return EasyObjectUtil.typeCastNullable(Draft7Proxy.class);
    }
}
