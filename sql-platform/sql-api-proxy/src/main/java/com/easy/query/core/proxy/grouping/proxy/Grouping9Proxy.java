...
import com.easy.query.core.proxy.grouping.Grouping9;
 ...
 * @author xuejiaming
 */
public class Grouping9Proxy<TKey1Proxy extends PropTypeColumn<TKey1>, TKey1,
        ...
        TSourceProxy>
        extends AbstractGrouping1Proxy<Grouping9Proxy<TKey1Proxy, TKey1, TKey2Proxy, TKey2, TKey3Proxy, TKey3, TKey4Proxy, TKey4, TKey5Proxy, TKey5, TKey6Proxy, TKey6, TKey7Proxy, TKey7, TKey8Proxy, TKey8, TKey9Proxy, TKey9, TSourceProxy>,
        Grouping9<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6, TKey7, TKey8, TKey9>, TSourceProxy> {

    private static final Class<Grouping9> entityClass = Grouping9.class;
    ...
    public Grouping9Proxy(TKey1Proxy k1, TKey2Proxy k2, TKey3Proxy k3, TKey4Proxy k4, TKey5Proxy k5, TKey6Proxy k6, TKey7Proxy k7, TKey8Proxy k8, TKey9Proxy k9, TSourceProxy tSourceProxy) {
        super(tSourceProxy);
        this.k1 = k1;
        this.k2 = k2;
        this.k3 = k3;
    ...
    @Override
    public Class<Grouping9<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6, TKey7, TKey8, TKey9>> getEntityClass() {
