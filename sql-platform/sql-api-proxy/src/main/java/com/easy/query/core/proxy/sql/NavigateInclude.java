...
// * @author xuejiaming
// */
//public class NavigateInclude<TPropertyProxy extends ProxyEntity<TPropertyProxy, TProperty>, TProperty extends ProxyEntityAvailable<TProperty, TPropertyProxy>> implements IncludeAvailable {
...
//
//    public NavigateInclude(SQLQueryable<TPropertyProxy, TProperty> includeMany) {
//        this.navValue = includeMany.getNavValue();
//        this.proxyInstance = includeMany.getProxy();
//        this.includes.add(this);
//    }
//
//    public NavigateInclude(TPropertyProxy includeOne) {
//        this.navValue = includeOne.getNavValue();
//        this.proxyInstance = includeOne;
//        this.includes.add(this);
//    }
//
//    public NavigateInclude<TPropertyProxy, TProperty> where(SQLActionExpression1<TPropertyProxy> filter) {
//        functions.add(q -> {
...
//    }
//
//    public NavigateInclude<TPropertyProxy, TProperty> orderBy(SQLActionExpression1<TPropertyProxy> orderBy) {
//        functions.add(q -> {
...
//    }
//
//    public NavigateInclude<TPropertyProxy, TProperty> limit(long offset, long rows) {
//        functions.add(q -> {
...
//    }
//
//    public <TRProxy extends ProxyEntity<TRProxy, TR>, TR> NavigateInclude<TPropertyProxy, TProperty> select(SQLFuncExpression1<TPropertyProxy, TRProxy> selector) {
//
//        functions.add(q -> {
