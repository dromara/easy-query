...
/**
 * create time 2025/4/15 08:47
 * 文件说明
 *
 * @author xuejiaming
 */
public class Part6<TEntity, TValue1, TValue2, TValue3, TValue4, TValue5, TValue6> implements PartResult<TEntity> {
    ...
    // 新增 getPartColumn6/setPartColumn6
