...
public interface EntityOrderable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> orderBy(SQLFuncExpression3<T1Proxy, T2Proxy, T3Proxy, SQLOrderSelect> selectExpression) {
        return orderBy(true, selectExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> orderBy(boolean condition, SQLFuncExpression3<T1Proxy, T2Proxy, T3Proxy, SQLOrderSelect> selectExpression) {
        if (condition) {
            getClientQueryable3().orderByAsc((selector1, selector2, selector3) -> {
                SQLOrderSelect sqlOrderSelect = selectExpression.apply(get1Proxy(), get2Proxy(), get3Proxy());
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> orderByMerge(SQLFuncExpression1<Tuple3<T1Proxy, T2Proxy, T3Proxy>,SQLOrderSelect> selectExpression) {
        return orderByMerge(true, selectExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> orderByMerge(boolean condition, SQLFuncExpression1<Tuple3<T1Proxy, T2Proxy, T3Proxy>,SQLOrderSelect> selectExpression) {
