...
import com.easy.query.api.proxy.select.extension.queryable9.AbstractOverrideProxyQueryable9;
...
public abstract class AbstractProxyQueryable9<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    public AbstractProxyQueryable9(T1Proxy t1Proxy, T2Proxy t2Proxy, T3Proxy t3Proxy, T4Proxy t4Proxy, T5Proxy t5Proxy, T6Proxy t6Proxy, T7Proxy t7Proxy, T8Proxy t8Proxy, T9Proxy t9Proxy, ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> entityQueryable) {
        ...
        this.t8Proxy = t8Proxy.create(sqlEntityExpressionBuilder.getTable(7).getEntityTable());
        this.t9Proxy = t9Proxy.create(sqlEntityExpressionBuilder.getTable(8).getEntityTable());
    }
