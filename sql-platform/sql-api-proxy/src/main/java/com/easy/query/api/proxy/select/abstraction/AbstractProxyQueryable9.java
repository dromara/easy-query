...
import com.easy.query.api.proxy.select.extension.queryable9.override.AbstractOverrideProxyQueryable9;
 ...
 * @author xuejiaming
 */
public abstract class AbstractProxyQueryable9<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        ...
        extends AbstractOverrideProxyQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9>
        implements ProxyQueryable9<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4, T5Proxy, T5, T6Proxy, T6, T7Proxy, T7, T8Proxy, T8, T9Proxy, T9> {
