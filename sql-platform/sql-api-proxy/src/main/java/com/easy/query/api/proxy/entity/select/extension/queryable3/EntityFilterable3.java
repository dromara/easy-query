...
public interface EntityFilterable3<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where(SQLExpression3<T1Proxy, T2Proxy, T3Proxy> whereExpression) {
        return where(true,whereExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> where(boolean condition, SQLExpression3<T1Proxy, T2Proxy, T3Proxy> whereExpression) {
        if (condition) {
    ...
    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> whereMerge(SQLExpression1<MergeTuple3<T1Proxy, T2Proxy, T3Proxy>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default EntityQueryable3<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3> whereMerge(boolean condition, SQLExpression1<MergeTuple3<T1Proxy, T2Proxy, T3Proxy>> whereExpression) {
