 ...
 * @author xuejiaming
 */
public class MultiProxySelector4Impl<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
        T2Proxy extends ProxyEntity<T2Proxy, T2>, T2,
        T3Proxy extends ProxyEntity<T3Proxy, T3>, T3,
        T4Proxy extends ProxyEntity<T4Proxy, T4>, T4> implements MultiProxySelector4<T1Proxy, T2Proxy, T3Proxy, T4Proxy> {
    ...
    public MultiProxySelector4Impl(Selector selector, T1Proxy t, T2Proxy t1, T3Proxy t2, T4Proxy t3) {
