...
public class LQuery6<T1, T2, T3, T4, T5, T6> extends QueryBase
{
    ...
    public <R> NoWayQuery<R> selectAutoInclude(@Expr Func6<T1, T2, T3, T4, T5, T6, R> expr)
    {
        throw new RuntimeException();
    }

    public <R> NoWayQuery<R> selectAutoInclude(ExprTree<Func6<T1, T2, T3, T4, T5, T6, R>> expr)
    {
        Select select = new Select(expr.getTree());
