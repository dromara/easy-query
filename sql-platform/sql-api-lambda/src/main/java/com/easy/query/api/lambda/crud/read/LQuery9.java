...
public class LQuery9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends QueryBase
{
    ...
    public <R> EndQuery<R> selectAutoInclude(@Expr Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> expr)
    {
        throw new RuntimeException();
    }

    public <R> EndQuery<R> selectAutoInclude(ExprTree<Func9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R>> expr)
    {
        Select select = new Select(expr.getTree());
