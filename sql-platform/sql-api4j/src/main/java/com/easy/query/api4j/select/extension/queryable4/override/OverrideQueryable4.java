...
public interface OverrideQueryable4<T1, T2, T3, T4> extends Queryable<T1>, Queryable4Available<T1, T2, T3, T4> {
    ...
    @Override
    Queryable4<T1, T2, T3, T4> asTableSegment(BiFunction<String, String, String> segmentAs);

    @Override
    Queryable4<T1, T2, T3, T4> filterConfigure(ValueFilter valueFilter);

    @Override
    Queryable4<T1, T2, T3, T4> configure(SQLExpression1<ContextConfigurer> configurer);
}
