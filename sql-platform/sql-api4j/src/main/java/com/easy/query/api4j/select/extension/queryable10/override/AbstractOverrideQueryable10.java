...
public abstract class AbstractOverrideQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends AbstractQueryable<T1> implements Queryable10Available<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
    ...
    @Override
    public Queryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> asTableSegment(BiFunction<String, String, String> segmentAs) {
        super.asTableSegment(segmentAs);
        return getQueryable10();
    }

    @Override
    public Queryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> filterConfigure(ValueFilter valueFilter) {
        super.filterConfigure(valueFilter);
        return getQueryable10();
    }

    @Override
    public Queryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> configure(SQLExpression1<ContextConfigurer> configurer) {
