...
public abstract class AbstractOverrideQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AbstractQueryable<T1> implements Queryable9Available<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    @Override
    public Queryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public Queryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> configure(SQLExpression1<ContextConfigurer> configurer) {
