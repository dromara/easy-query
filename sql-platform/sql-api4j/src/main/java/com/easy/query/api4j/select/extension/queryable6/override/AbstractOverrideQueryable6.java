...
public abstract class AbstractOverrideQueryable6<T1, T2, T3, T4, T5, T6> extends AbstractQueryable<T1> implements Queryable6Available<T1, T2, T3, T4, T5, T6> {
    ...
    @Override
    public Queryable6<T1, T2, T3, T4, T5, T6> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public Queryable6<T1, T2, T3, T4, T5, T6> configure(SQLExpression1<ContextConfigurer> configurer) {
