...
public interface OverrideQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> extends Queryable<T1>, Queryable8Available<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    @Override
    default <TProperty> Queryable8<T1, T2, T3, T4, T5, T6, T7, T8> whereByIds(Collection<TProperty> ids) {
     ...
     */
    @Override
    default Queryable8<T1, T2, T3, T4, T5, T6, T7, T8> orderByObject(ObjectSort configuration) {
     ...
     */
    @Override
    Queryable8<T1, T2, T3, T4, T5, T6, T7, T8> orderByObject(boolean condition, ObjectSort configuration);
    ...
    @Override
    Queryable8<T1, T2, T3, T4, T5, T6, T7, T8> asTableSegment(BiFunction<String, String, String> segmentAs);

    @Override
    Queryable8<T1, T2, T3, T4, T5, T6, T7, T8> filterConfigure(ValueFilter valueFilter);

    @Override
    Queryable8<T1, T2, T3, T4, T5, T6, T7, T8> configure(SQLExpression1<ContextConfigurer> configurer);
}
