...
import com.easy.query.core.expression.lambda.MultiProperty;
...
public class EasyLambdaUtil {
    ...
    public static <T> String getPropertyName(Property<T, ?> property) {
        ...
        if(property instanceof MultiProperty){
            return ((MultiProperty)property).getFullPropertyName();
        }
        try {
    ...
    public static <T> String getPropertyName2(Property<T, ?> property) {
        ...
        try {
            ...
            switch (serializedLambda.getImplMethodKind()){
                ...
                //Class.method.method....
                case MethodHandleInfo.REF_invokeStatic: return getPropertyNameByInvokeStatic(property.getClass().getClassLoader(), serializedLambda);
            }
             return getPropertyNameByInvokeVirtual(serializedLambda);
