...
public abstract class AbstractOverrideQueryable4<T1, T2, T3, T4> extends AbstractQueryable<T1> implements Queryable4Available<T1, T2, T3, T4> {
    ...
    @Override
    public Queryable4<T1, T2, T3, T4> asTableSegment(BiFunction<String, String, String> segmentAs) {
        super.asTableSegment(segmentAs);
        return getQueryable4();
    }

    @Override
    public Queryable4<T1, T2, T3, T4> filterConfigure(ValueFilter valueFilter) {
        super.filterConfigure(valueFilter);
        return getQueryable4();
    }

    @Override
    public Queryable4<T1, T2, T3, T4> configure(SQLExpression1<ContextConfigurer> configurer) {
