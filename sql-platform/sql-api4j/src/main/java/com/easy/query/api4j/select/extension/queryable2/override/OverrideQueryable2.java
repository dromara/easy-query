...
public interface OverrideQueryable2<T1, T2> extends Queryable<T1>, Queryable2Available<T1, T2> {
     ...
     */
    @Override
    default Queryable2<T1, T2> orderByObject(ObjectSort configuration) {
     ...
     */
    @Override
    Queryable2<T1, T2> orderByObject(boolean condition, ObjectSort configuration);
    ...
    @Override
    Queryable2<T1, T2> asTableSegment(BiFunction<String, String, String> segmentAs);

    @Override
    Queryable2<T1, T2> filterConfigure(ValueFilter valueFilter);
    @Override
    Queryable2<T1, T2> configure(SQLExpression1<ContextConfigurer> configurer);
}
