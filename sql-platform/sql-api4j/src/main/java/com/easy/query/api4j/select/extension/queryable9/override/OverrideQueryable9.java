...
public interface OverrideQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Queryable<T1>, Queryable9Available<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    @Override
    Queryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> asTableSegment(BiFunction<String, String, String> segmentAs);

    @Override
    Queryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> filterConfigure(ValueFilter valueFilter);

    @Override
    Queryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> configure(SQLExpression1<ContextConfigurer> configurer);
}
