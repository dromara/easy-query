...
public interface OverrideQueryable5<T1, T2, T3, T4, T5> extends Queryable<T1>, Queryable5Available<T1, T2, T3, T4, T5> {
    ...
    @Override
    Queryable5<T1, T2, T3, T4, T5> asTableSegment(BiFunction<String, String, String> segmentAs);

    @Override
    Queryable5<T1, T2, T3, T4, T5> filterConfigure(ValueFilter valueFilter);

    @Override
    Queryable5<T1, T2, T3, T4, T5> configure(SQLExpression1<ContextConfigurer> configurer);
}
