...
public abstract class AbstractOverrideQueryable3<T1, T2, T3> extends AbstractQueryable<T1> implements Queryable3Available<T1, T2, T3> {
    ...
    @Override
    public Queryable3<T1, T2,T3> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public Queryable3<T1, T2,T3> configure(SQLExpression1<ContextConfigurer> configurer) {
