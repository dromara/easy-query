...
public interface SQLKtWherePredicate<T1> {
    ...
    default <TProperty> SQLKtWherePredicate<T1> in(Property<T1, ?> column, TProperty[] collection) {
        getWherePredicate().in(EasyLambdaUtil.getPropertyName(column), collection);
        return this;
    }
    default <TProperty> SQLKtWherePredicate<T1> in(boolean condition, Property<T1, ?> column, TProperty[] collection) {
        getWherePredicate().in(condition, EasyLambdaUtil.getPropertyName(column), collection);
        return this;
    }
    ...
    default <TProperty> SQLKtWherePredicate<T1> notIn(Property<T1, ?> column, TProperty[] collection) {
        getWherePredicate().notIn(EasyLambdaUtil.getPropertyName(column), collection);
        return this;
    }
    default <TProperty> SQLKtWherePredicate<T1> notIn(boolean condition, Property<T1, ?> column, TProperty[] collection) {
        getWherePredicate().notIn(condition, EasyLambdaUtil.getPropertyName(column), collection);
        return this;
    }
