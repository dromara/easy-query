...
public abstract class AbstractOverrideKtQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> extends AbstractKtQueryable<T1> implements KtQueryable8Available<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    @Override
    public KtQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> asTableSegment(BiFunction<String, String, String> segmentAs) {
        super.asTableSegment(segmentAs);
        return getQueryable8();
    }
    @Override
    public KtQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> filterConfigure(ValueFilter valueFilter) {
        super.filterConfigure(valueFilter);
        return getQueryable8();
    }
    @Override
    public KtQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> configure(SQLExpression1<ContextConfigurer> configurer) {
