...
public abstract class AbstractOverrideKtQueryable6<T1, T2, T3, T4, T5, T6> extends AbstractKtQueryable<T1> implements KtQueryable6Available<T1, T2, T3, T4, T5, T6> {
    ...
    @Override
    public KtQueryable6<T1, T2, T3, T4, T5, T6> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public KtQueryable6<T1, T2, T3, T4, T5, T6> configure(SQLExpression1<ContextConfigurer> configurer) {
