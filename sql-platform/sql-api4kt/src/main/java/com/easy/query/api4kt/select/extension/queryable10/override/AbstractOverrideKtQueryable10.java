...
public abstract class AbstractOverrideKtQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends AbstractKtQueryable<T1> implements KtQueryable10Available<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
    ...
    @Override
    public KtQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public KtQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> configure(SQLExpression1<ContextConfigurer> configurer) {
