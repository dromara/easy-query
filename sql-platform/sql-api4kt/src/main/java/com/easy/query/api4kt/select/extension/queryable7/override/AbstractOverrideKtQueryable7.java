...
public abstract class AbstractOverrideKtQueryable7<T1, T2, T3,T4,T5,T6,T7> extends AbstractKtQueryable<T1> implements KtQueryable7Available<T1, T2, T3,T4,T5,T6,T7> {
    ...
    @Override
    public KtQueryable7<T1, T2,T3,T4,T5,T6,T7> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public KtQueryable7<T1, T2,T3,T4,T5,T6,T7> configure(SQLExpression1<ContextConfigurer> configurer) {
