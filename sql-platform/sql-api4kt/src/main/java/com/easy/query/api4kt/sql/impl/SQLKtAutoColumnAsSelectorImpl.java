 ...
 * @Date: 2023/2/8 00:10
 */
public class SQLKtAutoColumnAsSelectorImpl<T1, TR> implements SQLKtColumnAsSelector<T1, TR> {

    private final ColumnAsSelector<T1, TR> columnAsSelector;

    public SQLKtAutoColumnAsSelectorImpl(ColumnAsSelector<T1, TR> columnAsSelector) {
