...
public abstract class AbstractOverrideKtQueryable5<T1, T2, T3,T4,T5> extends AbstractKtQueryable<T1> implements KtQueryable5Available<T1, T2, T3,T4,T5> {
    ...
    @Override
    public KtQueryable5<T1, T2,T3,T4,T5> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public KtQueryable5<T1, T2,T3,T4,T5> configure(SQLExpression1<ContextConfigurer> configurer) {
