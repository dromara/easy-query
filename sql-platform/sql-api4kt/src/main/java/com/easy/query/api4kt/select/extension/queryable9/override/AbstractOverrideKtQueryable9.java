...
public abstract class AbstractOverrideKtQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AbstractKtQueryable<T1> implements KtQueryable9Available<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    @Override
    public KtQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public KtQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> configure(SQLExpression1<ContextConfigurer> configurer){
