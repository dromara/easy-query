...
import com.easy.query.api4kt.sql.core.SQLColumnLambdaKtNative;
 ...
 * @author xuejiaming
 */
public interface SQLKtColumnSetSelector<T1> extends EntitySQLTableOwner<T1>, SQLColumnLambdaKtNative<T1,SQLKtColumnSetSelector<T1>> {
