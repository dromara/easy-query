 ...
 */
public class LocalDateTimeGlobalEntityTypeConfiguration implements GlobalEntityTypeConfiguration {
    @Override
    public LogicDeleteStrategyEnum getStrategy() {
        return LogicDeleteStrategyEnum.LOCAL_DATE_TIME;
    }
    ...
    public void configure(GlobalEntityTypeBuilder builder, String propertyName, Class<?> propertyType) {
        ...
        builder.configLogicDelete(o -> {
            ...
            o.set(functionField, LocalDateTime.now());
        });
    }
}
