...
public class SelectContext extends AbstractSqlContext {
    ...
    public SelectContext(SelectContext selectContext) {
        this(selectContext.getRuntimeContext(), "t", selectContext);
    }
    public SelectContext(EasyQueryRuntimeContext runtimeContext, String alias) {
        this(runtimeContext, alias, null);
    }

    public SelectContext(EasyQueryRuntimeContext runtimeContext, String alias, SelectContext selectContext) {
