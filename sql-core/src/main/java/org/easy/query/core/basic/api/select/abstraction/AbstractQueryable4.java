...
import org.easy.query.core.basic.api.select.provider.EasyQuerySqlBuilderProvider4;
import org.easy.query.core.basic.api.select.provider.Select4SqlProvider;
...
public abstract class AbstractQueryable4<T1, T2, T3,T4> extends AbstractQueryable<T1> implements Queryable4<T1, T2, T3,T4> {
    ...
    @Override
    public Queryable4<T1, T2, T3,T4> noQueryFilter() {
        super.noQueryFilter();
        return this;
    }

    @Override
    public Queryable4<T1, T2, T3,T4> useQueryFilter() {
