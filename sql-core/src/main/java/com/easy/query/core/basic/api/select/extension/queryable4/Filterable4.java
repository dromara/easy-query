...
public interface Filterable4<T1, T2, T3,T4> {
    ...
    default ClientQueryable4<T1, T2, T3,T4> whereMerge(SQLActionExpression1<Tuple4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default ClientQueryable4<T1, T2, T3,T4> whereMerge(boolean condition, SQLActionExpression1<Tuple4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>>> whereExpression) {
