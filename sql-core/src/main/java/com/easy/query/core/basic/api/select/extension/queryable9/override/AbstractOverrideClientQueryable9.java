...
public abstract class AbstractOverrideClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AbstractClientQueryable<T1> {
    ...
    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> where(boolean condition, SQLActionExpression1<WherePredicate<T1>> whereExpression) {
        super.where(condition, whereExpression);
        return getClientQueryable9();
    }

    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> orderByAsc(boolean condition, SQLActionExpression1<ColumnOrderSelector<T1>> selectExpression) {
        super.orderByAsc(condition, selectExpression);
        return getClientQueryable9();
    }

    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> orderByDesc(boolean condition, SQLActionExpression1<ColumnOrderSelector<T1>> selectExpression) {
        super.orderByAsc(condition, selectExpression);
        return getClientQueryable9();
    }

    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> groupBy(boolean condition, SQLActionExpression1<ColumnGroupSelector<T1>> selectExpression) {
        super.groupBy(condition, selectExpression);
        return getClientQueryable9();
    }

    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> having(boolean condition, SQLActionExpression1<WhereAggregatePredicate<T1>> predicateExpression) {
    ...
    @Override
    public <TProperty> ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> include(boolean condition, SQLFuncExpression1<NavigateInclude, ClientQueryable<TProperty>> navigateIncludeSQLExpression) {
    ...
    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> asTableSegment(BiFunction<String, String, String> segmentAs) {
    ...
    @Override
    public ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8,T9> configure(SQLActionExpression1<ContextConfigurer> configurer) {
