...
public interface Havingable5<T1, T2, T3, T4, T5> {
    ...
    default ClientQueryable5<T1, T2, T3, T4, T5> havingMerge(SQLActionExpression1<Tuple5<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>>> predicateExpression) {
        return havingMerge(true, predicateExpression);
    }

    default ClientQueryable5<T1, T2, T3, T4, T5> havingMerge(boolean condition, SQLActionExpression1<Tuple5<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>>> predicateExpression) {
