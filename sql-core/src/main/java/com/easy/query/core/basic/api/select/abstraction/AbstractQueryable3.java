...
public abstract class AbstractQueryable3<T1, T2, T3> extends AbstractQueryable<T1> implements Queryable3<T1, T2, T3> {
    ...
    public AbstractQueryable3(Class<T1> t1Class, Class<T2> t2Class, Class<T3> t3Class, EntityQueryExpression sqlEntityExpression) {
    ...
    @Override
    public Queryable3<T1, T2, T3> interceptor(String name) {
