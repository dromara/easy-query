...
public class MathSQLFunction extends AbstractExpressionSQLFunction {
    ...
    public MathSQLFunction(List<ColumnExpression> columnExpressions, MathMethodEnum mathMethodEnum) {
    ...
    public String sqlSegment(TableAvailable defaultTable) {
        ...
        throw new UnsupportedOperationException("不支持当前函数MathSQLFunction:"+ mathMethodEnum);
    }
