...
public class DefaultSQLClientApiFactory implements SQLClientApiFactory {
    ...
    @Override
    public <T> ClientQueryable<T> createSubQueryable(Class<T> clazz, QueryRuntimeContext runtimeContext, ExpressionContext parentExpressionContext) {
        ClientQueryable<T> queryable = createQueryable(clazz, runtimeContext);
        EasySQLExpressionUtil.propagationValueFilter(queryable, parentExpressionContext);
        return queryable;
    }
...
//       innerSqlEntityQueryExpression.addSqlEntityTableExpression(sqlTable);
    ...
    @Override
    public <T> ClientQueryable<T> createQueryable(Class<T> clazz, EntityMetadata entityMetadata, EntityQueryExpressionBuilder entityQueryExpressionBuilder) {
...
//            EntityTableExpressionBuilder sqlTable = expressionBuilderFactory.createEntityTableExpressionBuilder(entityMetadata, selectTableInfoType, entityQueryExpressionBuilder.getRuntimeContext());
    ...
    public <T1, T2> ClientQueryable2<T1, T2> createQueryable2(Class<T1> t1Class, Class<T2> t2Class, MultiTableTypeEnum selectTableInfoType, EntityQueryExpressionBuilder entityQueryExpressionBuilder) {
        ...
        ExpressionContext queryExpressionContext = entityQueryExpressionBuilder.getExpressionContext();
        EntityTableExpressionBuilder sqlTable = expressionBuilderFactory.createEntityTableExpressionBuilder(entityMetadata, selectTableInfoType, queryExpressionContext);
        entityQueryExpressionBuilder.addSQLEntityTableExpression(sqlTable);
