 ...
 * @author xuejiaming
 */
public class JSONObjectExtractSQLFunction extends AbstractExpressionSQLFunction {

    private final List<ColumnExpression> columnExpressions;

    public JSONObjectExtractSQLFunction(List<ColumnExpression> concatExpressions) {
