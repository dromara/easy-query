...
public interface Joinable3<T1, T2,T3> {
    <T4> ClientQueryable4<T1, T2, T3,T4> leftJoin(Class<T4> joinClass, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);

    <T4> ClientQueryable4<T1, T2, T3,T4> leftJoin(ClientQueryable<T4> joinQueryable, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);

    <T4> ClientQueryable4<T1, T2, T3,T4> rightJoin(Class<T4> joinClass, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);

    <T4> ClientQueryable4<T1, T2, T3,T4> rightJoin(ClientQueryable<T4> joinQueryable, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);

    <T4> ClientQueryable4<T1, T2, T3,T4> innerJoin(Class<T4> joinClass, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);
    ...
    <T4> ClientQueryable4<T1, T2, T3,T4> crossJoin(Class<T4> joinClass, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);

    <T4> ClientQueryable4<T1, T2, T3,T4> crossJoin(ClientQueryable<T4> joinQueryable, SQLActionExpression4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>> on);
    ...
    default <T4> ClientQueryable4<T1, T2, T3,T4> crossJoinMerge(Class<T4> joinClass, SQLActionExpression1<EasyTuple4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>>> on){
        return crossJoin(joinClass,(t,t1,t2,t3)->{
            on.apply(new EasyTuple4<>(t,t1,t2,t3));
        });
    }

    default <T4> ClientQueryable4<T1, T2, T3,T4> crossJoinMerge(ClientQueryable<T4> joinQueryable, SQLActionExpression1<EasyTuple4<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>>> on){
        return crossJoin(joinQueryable,(t,t1,t2,t3)->{
            on.apply(new EasyTuple4<>(t,t1,t2,t3));
        });
    }
