...
public interface Filterable3<T1, T2, T3> {
    ...
    default ClientQueryable3<T1, T2, T3> whereMerge(SQLActionExpression1<Tuple3<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default ClientQueryable3<T1, T2, T3> whereMerge(boolean condition, SQLActionExpression1<Tuple3<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>>> whereExpression) {
