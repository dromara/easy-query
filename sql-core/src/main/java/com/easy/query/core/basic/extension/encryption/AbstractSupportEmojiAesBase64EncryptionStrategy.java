...
/**
 * create time 2023/9/6 13:18
 * 支持emoji表情符和全中英文特殊字符的加密策略
 * 和{@link AbstractUnSupportEmojiAesBase64EncryptionStrategy} 相比性能相对较低一点主要在字符串的截取和需判断是否是一个完整的字符
 * 但是支持所有的文本适合在文本或者其他地方加密使用
 *
 * @author xuejiaming
 */
public abstract class AbstractSupportEmojiAesBase64EncryptionStrategy  implements EncryptionStrategy {
    private static final Log log = LogFactory.getLog(AbstractSupportEmojiAesBase64EncryptionStrategy.class);
