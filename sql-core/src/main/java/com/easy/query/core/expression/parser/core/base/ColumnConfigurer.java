...
public interface ColumnConfigurer<T1> extends EntitySQLTableOwner<T1> {
    ...
    default ColumnConfigurer<T1> column(String property, String sqlSegment, SQLActionExpression2<SQLNativePropertyExpressionContext, SQLParameter> contextConsume){
