...
public abstract class AbstractOverrideClientQueryable7<T1, T2, T3, T4, T5, T6, T7> extends AbstractClientQueryable<T1> {
    ...
    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> where(boolean condition, SQLExpression1<WherePredicate<T1>> whereExpression) {
        super.where(condition, whereExpression);
        return getClientQueryable7();
    }

    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> orderByAsc(boolean condition, SQLExpression1<ColumnOrderSelector<T1>> selectExpression) {
        super.orderByAsc(condition, selectExpression);
        return getClientQueryable7();
    }

    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> orderByDesc(boolean condition, SQLExpression1<ColumnOrderSelector<T1>> selectExpression) {
        super.orderByAsc(condition, selectExpression);
        return getClientQueryable7();
    }

    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> groupBy(boolean condition, SQLExpression1<ColumnGroupSelector<T1>> selectExpression) {
        super.groupBy(condition, selectExpression);
        return getClientQueryable7();
    }

    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> having(boolean condition, SQLExpression1<WhereAggregatePredicate<T1>> predicateExpression) {
    ...
    @Override
    public <TProperty> ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> include(boolean condition, SQLFuncExpression1<NavigateInclude<T1>, ClientQueryable<TProperty>> navigateIncludeSQLExpression) {
    ...
    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> queryLargeColumn(boolean queryLarge) {
    ...
    @Override
    public ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> behaviorConfigure(SQLExpression1<EasyBehavior> configure) {
