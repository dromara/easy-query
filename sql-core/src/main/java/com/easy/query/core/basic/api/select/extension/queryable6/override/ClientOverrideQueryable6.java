...
public interface ClientOverrideQueryable6<T1, T2, T3, T4, T5, T6> extends ClientQueryable<T1> {
    ...
    @Override
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> where(SQLExpression1<WherePredicate<T1>> whereExpression) {
        return where(true, whereExpression);
    }

    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> where(boolean condition, SQLExpression1<WherePredicate<T1>> whereExpression);

    @Override
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> groupBy(SQLExpression1<ColumnGroupSelector<T1>> selectExpression) {
        return groupBy(true, selectExpression);
    }

    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> groupBy(boolean condition, SQLExpression1<ColumnGroupSelector<T1>> selectExpression);

    @Override
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> having(SQLExpression1<WhereAggregatePredicate<T1>> predicateExpression) {
        return having(true, predicateExpression);
    }

    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> having(boolean condition, SQLExpression1<WhereAggregatePredicate<T1>> predicateExpression);

    @Override
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByAsc(SQLExpression1<ColumnOrderSelector<T1>> selectExpression) {
        return orderByAsc(true, selectExpression);
    }

    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByAsc(boolean condition, SQLExpression1<ColumnOrderSelector<T1>> selectExpression);

    @Override
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByDesc(SQLExpression1<ColumnOrderSelector<T1>> selectExpression) {
        return orderByDesc(true, selectExpression);
    }

    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByDesc(boolean condition, SQLExpression1<ColumnOrderSelector<T1>> selectExpression);

    @Override
    default <TREntity> ClientQueryable6<T1, T2, T3, T4, T5, T6> include(SQLFuncExpression1<NavigateInclude<T1>, ClientQueryable<TREntity>> navigateIncludeSQLExpression) {
        return include(true, navigateIncludeSQLExpression);
    }

    @Override
    <TREntity> ClientQueryable6<T1, T2, T3, T4, T5, T6> include(boolean condition, SQLFuncExpression1<NavigateInclude<T1>, ClientQueryable<TREntity>> navigateIncludeSQLExpression);
    ...
    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> queryLargeColumn(boolean queryLarge);
    ...
    @Override
    ClientQueryable6<T1, T2, T3, T4, T5, T6> behaviorConfigure(SQLExpression1<EasyBehavior> configure);
}
