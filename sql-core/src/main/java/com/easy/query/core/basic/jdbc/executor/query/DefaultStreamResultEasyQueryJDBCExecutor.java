 ...
 * @author xuejiaming
 */
public class DefaultStreamResultEasyQueryJDBCExecutor extends AbstractEasyQueryJDBCExecutor{
    public DefaultStreamResultEasyQueryJDBCExecutor(StreamMergeContext streamMergeContext) {
