...
public interface Joinable9<T1, T2,T3,T4,T5,T6,T7,T8,T9> {
    ...
    <T10> ClientQueryable10<T1, T2, T3,T4,T5,T6,T7,T8,T9,T10> crossJoin(Class<T10> joinClass, SQLActionExpression10<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>, WherePredicate<T10>> on);

    <T10> ClientQueryable10<T1, T2, T3,T4,T5,T6,T7,T8,T9,T10> crossJoin(ClientQueryable<T10> joinQueryable, SQLActionExpression10<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>, WherePredicate<T10>> on);
    ...
    default <T10> ClientQueryable10<T1, T2, T3,T4,T5,T6,T7,T8,T9,T10> crossJoinMerge(Class<T10> joinClass, SQLActionExpression1<EasyTuple10<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>, WherePredicate<T10>>> on){
        return crossJoin(joinClass,(t,t1,t2,t3,t4,t5,t6,t7,t8,t9)->{
            on.apply(new EasyTuple10<>(t,t1,t2,t3,t4,t5,t6,t7,t8,t9));
        });
    }

    default <T10> ClientQueryable10<T1, T2, T3,T4,T5,T6,T7,T8,T9,T10> crossJoinMerge(ClientQueryable<T10> joinQueryable, SQLActionExpression1<EasyTuple10<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>, WherePredicate<T10>>> on){
        return crossJoin(joinQueryable,(t,t1,t2,t3,t4,t5,t6,t7,t8,t9)->{
            on.apply(new EasyTuple10<>(t,t1,t2,t3,t4,t5,t6,t7,t8,t9));
        });
    }
