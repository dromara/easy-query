...
public interface Filterable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    default ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> whereMerge(SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> whereMerge(boolean condition, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> whereExpression) {
