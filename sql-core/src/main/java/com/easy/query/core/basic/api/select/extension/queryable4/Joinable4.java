...
public interface Joinable4<T1, T2,T3,T4> {
    ...
    default <T5> ClientQueryable5<T1, T2, T3,T4,T5> leftJoinMerge(Class<T5> joinClass, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> on){
        return leftJoin(joinClass,(t,t1,t2,t3,t4)->{
            on.apply(new Tuple5<>(t,t1,t2,t3,t4));
        });
    }

    default <T5> ClientQueryable5<T1, T2, T3,T4,T5> leftJoinMerge(ClientQueryable<T5> joinQueryable, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> on){
        return leftJoin(joinQueryable,(t,t1,t2,t3,t4)->{
            on.apply(new Tuple5<>(t,t1,t2,t3,t4));
        });
    }

    default <T5> ClientQueryable5<T1, T2, T3,T4,T5> rightJoinMerge(Class<T5> joinClass, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> on){
        return rightJoin(joinClass,(t,t1,t2,t3,t4)->{
            on.apply(new Tuple5<>(t,t1,t2,t3,t4));
        });
    }

    default <T5> ClientQueryable5<T1, T2, T3,T4,T5> rightJoinMerge(ClientQueryable<T5> joinQueryable, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> on){
        return rightJoin(joinQueryable,(t,t1,t2,t3,t4)->{
            on.apply(new Tuple5<>(t,t1,t2,t3,t4));
        });
    }

    default <T5> ClientQueryable5<T1, T2, T3,T4,T5> innerJoinMerge(Class<T5> joinClass, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> on){
        return innerJoin(joinClass,(t,t1,t2,t3,t4)->{
            on.apply(new Tuple5<>(t,t1,t2,t3,t4));
        });
    }

    default <T5> ClientQueryable5<T1, T2, T3,T4,T5> innerJoinMerge(ClientQueryable<T5> joinQueryable, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> on){
