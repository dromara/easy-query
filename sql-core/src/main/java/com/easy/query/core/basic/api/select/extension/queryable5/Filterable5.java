...
public interface Filterable5<T1, T2, T3, T4, T5> {
    ...
    default ClientQueryable5<T1, T2, T3, T4, T5> whereMerge(SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default ClientQueryable5<T1, T2, T3, T4, T5> whereMerge(boolean condition, SQLActionExpression1<Tuple5<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>>> whereExpression) {
