 ...
 * @author xuejiaming
 */
public abstract class AbstractMonthTableRule<TEntity> extends AbstractTableRouteRule<TEntity> {
    /**
    ...
    protected RouteFunction<ActualTable> getRouteFilter(TableAvailable table, Object shardingValue, ShardingOperatorEnum shardingOperator, boolean withEntity) {
        ...
        switch (shardingOperator) {
            ...
            case LESS_THAN: {
                ...
                LocalDateTime timeMonthFirstDay = EasyUtil.getMonthStart(shardingTime);
