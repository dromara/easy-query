...
public class SegmentSQLFunction extends AbstractExpressionSQLFunction {
    ...
    public SegmentSQLFunction(QueryRuntimeContext runtimeContext, ExpressionContext expressionContext, List<Tuple2<SQLExpression1<Filter>, ParamExpression>> whens, ParamExpression elseValue) {
