...
public interface Havingable7<T1, T2, T3, T4, T5, T6, T7> {
    ...
    default ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> havingMerge(SQLActionExpression1<Tuple7<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>, WhereAggregatePredicate<T6>, WhereAggregatePredicate<T7>>> predicateExpression) {
        return havingMerge(true, predicateExpression);
    }

    default ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> havingMerge(boolean condition, SQLActionExpression1<Tuple7<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>, WhereAggregatePredicate<T6>, WhereAggregatePredicate<T7>>> predicateExpression) {
