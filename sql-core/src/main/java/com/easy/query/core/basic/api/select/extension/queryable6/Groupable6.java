...
public interface Groupable6<T1, T2, T3, T4, T5, T6> {
    ...
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> groupByMerge(SQLActionExpression1<EasyTuple6<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>>> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default ClientQueryable6<T1, T2, T3, T4, T5, T6> groupByMerge(boolean condition, SQLActionExpression1<EasyTuple6<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>>> selectExpression) {
