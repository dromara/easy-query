...
public class CaseWhenSQLFunction extends AbstractExpressionSQLFunction {
    ...
    public CaseWhenSQLFunction(QueryRuntimeContext runtimeContext, ExpressionContext expressionContext, List<EasyTuple2<SQLActionExpression1<Filter>, ParamExpression>> whens, ParamExpression elseValue) {
