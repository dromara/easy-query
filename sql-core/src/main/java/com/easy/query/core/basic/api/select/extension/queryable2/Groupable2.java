...
public interface Groupable2<T1, T2> {
    ...
    default ClientQueryable2<T1, T2> groupByMerge(SQLActionExpression1<Tuple2<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>>> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default ClientQueryable2<T1, T2> groupByMerge(boolean condition, SQLActionExpression1<Tuple2<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>>> selectExpression) {
