...
public interface Filterable8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> whereMerge(SQLActionExpression1<Tuple8<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> whereMerge(boolean condition, SQLActionExpression1<Tuple8<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>>> whereExpression) {
