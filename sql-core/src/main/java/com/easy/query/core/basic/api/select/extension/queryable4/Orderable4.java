...
public interface Orderable4<T1, T2, T3, T4> {
    ...
    default ClientQueryable4<T1, T2, T3, T4> orderByAscMerge(SQLActionExpression1<EasyTuple4<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>>> selectExpression) {
        return orderByAscMerge(true, selectExpression);
    }

    default ClientQueryable4<T1, T2, T3, T4> orderByAscMerge(boolean condition, SQLActionExpression1<EasyTuple4<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>>> selectExpression) {
    ...
    default ClientQueryable4<T1, T2, T3, T4> orderByDescMerge(SQLActionExpression1<EasyTuple4<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>>> selectExpression) {
        return orderByDescMerge(true, selectExpression);
    }

    default ClientQueryable4<T1, T2, T3, T4> orderByDescMerge(boolean condition, SQLActionExpression1<EasyTuple4<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>>> selectExpression) {
