...
public interface EntityExpressionPrepareExecutor {
     ...
     * @param entityPredicateSQLExpression
     * @return
     */
    long executeRows(ExecutorContext executorContext, EntityPredicateExpressionBuilder entityPredicateExpressionBuilder, EntityPredicateSQLExpression entityPredicateSQLExpression);
