...
public interface Groupable4<T1, T2, T3, T4> {
    ...
    default ClientQueryable4<T1, T2, T3,T4> groupByMerge(SQLActionExpression1<Tuple4<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>>> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default ClientQueryable4<T1, T2, T3,T4> groupByMerge(boolean condition, SQLActionExpression1<Tuple4<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>>> selectExpression) {
