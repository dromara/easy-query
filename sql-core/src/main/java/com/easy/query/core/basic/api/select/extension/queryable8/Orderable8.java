...
public interface Orderable8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> orderByAscMerge(SQLActionExpression1<EasyTuple8<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>, ColumnOrderSelector<T7>, ColumnOrderSelector<T8>>> selectExpression) {
        return orderByAscMerge(true, selectExpression);
    }

    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> orderByAscMerge(boolean condition, SQLActionExpression1<EasyTuple8<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>, ColumnOrderSelector<T7>, ColumnOrderSelector<T8>>> selectExpression) {
    ...
    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> orderByDescMerge(SQLActionExpression1<EasyTuple8<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>, ColumnOrderSelector<T7>, ColumnOrderSelector<T8>>> selectExpression) {
        return orderByDescMerge(true, selectExpression);
    }

    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> orderByDescMerge(boolean condition, SQLActionExpression1<EasyTuple8<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>, ColumnOrderSelector<T7>, ColumnOrderSelector<T8>>> selectExpression) {
