 ...
 * @author xuejiaming
 */
public abstract class AbstractMonthTableRoute<TEntity> extends AbstractTimeTableRoute<TEntity> {
    @Override
    ...
    public boolean lessThanTimeStart(LocalDateTime shardingValue) {
        LocalDateTime timeMonthFirstDay = EasyUtil.getMonthStart(shardingValue);
        return shardingValue.isEqual(timeMonthFirstDay);
    }
}
