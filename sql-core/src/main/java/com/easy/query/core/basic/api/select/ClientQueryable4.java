...
public interface ClientQueryable4<T1, T2, T3, T4> extends ClientQueryable<T1> {
    ...
    //region order
    @Override
    default ClientQueryable4<T1, T2, T3, T4> orderByAsc(SQLExpression1<ColumnSelector<T1>> selectExpression) {
        return orderByAsc(true, selectExpression);
    }

    @Override
    ClientQueryable4<T1, T2, T3, T4> orderByAsc(boolean condition, SQLExpression1<ColumnSelector<T1>> selectExpression);

    default ClientQueryable4<T1, T2, T3, T4> orderByAsc(SQLExpression4<ColumnSelector<T1>, ColumnSelector<T2>, ColumnSelector<T3>, ColumnSelector<T4>> selectExpression) {
        return orderByAsc(true, selectExpression);
    }

    ClientQueryable4<T1, T2, T3, T4> orderByAsc(boolean condition, SQLExpression4<ColumnSelector<T1>, ColumnSelector<T2>, ColumnSelector<T3>, ColumnSelector<T4>> selectExpression);

    @Override
    default ClientQueryable4<T1, T2, T3, T4> orderByDesc(SQLExpression1<ColumnSelector<T1>> selectExpression) {
        return orderByDesc(true, selectExpression);
    }

    @Override
    ClientQueryable4<T1, T2, T3, T4> orderByDesc(boolean condition, SQLExpression1<ColumnSelector<T1>> selectExpression);

    default ClientQueryable4<T1, T2, T3, T4> orderByDesc(SQLExpression4<ColumnSelector<T1>, ColumnSelector<T2>, ColumnSelector<T3>, ColumnSelector<T4>> selectExpression) {
        return orderByDesc(true, selectExpression);
    }

    ClientQueryable4<T1, T2, T3, T4> orderByDesc(boolean condition, SQLExpression4<ColumnSelector<T1>, ColumnSelector<T2>, ColumnSelector<T3>, ColumnSelector<T4>> selectExpression);
    //endregion
    //region limit
