...
public interface Havingable8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> havingMerge(SQLActionExpression1<Tuple8<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>, WhereAggregatePredicate<T6>, WhereAggregatePredicate<T7>, WhereAggregatePredicate<T8>>> predicateExpression) {
        return havingMerge(true, predicateExpression);
    }

    default ClientQueryable8<T1, T2, T3, T4, T5, T6, T7, T8> havingMerge(boolean condition, SQLActionExpression1<Tuple8<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>, WhereAggregatePredicate<T6>, WhereAggregatePredicate<T7>, WhereAggregatePredicate<T8>>> predicateExpression) {
