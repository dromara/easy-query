...
public interface FuncColumnPredicate<T1, TChain> extends EntitySQLTableOwner<T1>, FilterAvailable, ChainCast<TChain> {
    ...
    default TChain gt(boolean condition, SQLFunction sqlFunctionLeft, SQLFunction sqlFunctionRight) {
        ...
        if (condition) {
            getFilter().gt(getTable(), sqlFunctionLeft, getTable(), sqlFunctionRight);
        }
        return castChain();
    }
    ...
    default TChain ge(boolean condition, SQLFunction sqlFunctionLeft, SQLFunction sqlFunctionRight) {
        ...
        if (condition) {
            getFilter().ge(getTable(), sqlFunctionLeft, getTable(), sqlFunctionRight);
        }
        return castChain();
    }
    ...
    default TChain eq(boolean condition, SQLFunction sqlFunctionLeft, SQLFunction sqlFunctionRight) {
        ...
        if (condition) {
            getFilter().eq(getTable(), sqlFunctionLeft, getTable(), sqlFunctionRight);
        }
        return castChain();
    }
    ...
    default TChain ne(boolean condition, SQLFunction sqlFunctionLeft, SQLFunction sqlFunctionRight) {
        if (condition) {
            getFilter().ne(getTable(), sqlFunctionLeft, getTable(), sqlFunctionRight);
        }
        return castChain();
    }
    ...
    default TChain le(boolean condition, SQLFunction sqlFunctionLeft, SQLFunction sqlFunctionRight) {
        if (condition) {
            getFilter().le(getTable(), sqlFunctionLeft, getTable(), sqlFunctionRight);
        }
        return castChain();
    }
    ...
    default TChain lt(boolean condition, SQLFunction sqlFunctionLeft, SQLFunction sqlFunctionRight) {
        if (condition) {
            getFilter().lt(getTable(), sqlFunctionLeft, getTable(), sqlFunctionRight);
        }
        return castChain();
    }
}
