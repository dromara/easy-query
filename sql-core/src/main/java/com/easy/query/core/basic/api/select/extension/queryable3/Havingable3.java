...
public interface Havingable3<T1, T2,T3> {
    ...
    default ClientQueryable3<T1, T2, T3> havingMerge(SQLActionExpression1<EasyTuple3<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>>> predicateExpression) {
        return havingMerge(true, predicateExpression);
    }

    default ClientQueryable3<T1, T2, T3> havingMerge(boolean condition, SQLActionExpression1<EasyTuple3<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>>> predicateExpression){
        return having(condition,(t,t1,t2)->{
            predicateExpression.apply(new EasyTuple3<>(t,t1,t2));
        });
    }
