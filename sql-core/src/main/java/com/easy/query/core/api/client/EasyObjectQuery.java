 ...
 * @Date: 2023/2/5 21:27
 */
public interface EasyObjectQuery {
    ...
    <T> ObjectQueryable<T> queryable(Class<T> clazz);

    <T> ObjectQueryable<T> queryable(String sql, Class<T> clazz);
    ...
    <T> ExpressionObjectUpdatable<T> updatable(Class<T> entityClass);

    <T> EntityObjectUpdatable<T> updatable(T entity);

    <T> EntityObjectUpdatable<T> updatable(Collection<T> entities);

    <T> EntityObjectDeletable<T> deletable(T entity);

    <T> EntityObjectDeletable<T> deletable(Collection<T> entities);

    <T> ExpressionObjectDeletable<T> deletable(Class<T> entityClass);
