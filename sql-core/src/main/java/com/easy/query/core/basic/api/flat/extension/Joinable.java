...
public interface Joinable {
    MapQueryable join(MultiTableTypeEnum joinTable, SQLActionExpression1<MapFilter> on);
    MapQueryable join(MultiTableTypeEnum joinTable,MapQueryable mapQueryable, SQLActionExpression1<MapFilter> on);
