...
public interface Selectable2<T1,T2> {
    ...
    default <TR> ClientQueryable<TR> selectMerge(Class<TR> resultClass, SQLActionExpression1<Tuple2<ColumnAsSelector<T1, TR>, ColumnAsSelector<T2, TR>>> selectExpression) {
