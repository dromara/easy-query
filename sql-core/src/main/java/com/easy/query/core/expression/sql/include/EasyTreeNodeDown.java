 ...
 * @author xuejiaming
 */
public class EasyTreeNodeDown<T> implements EasyTreeNode<T> {
    ...
    public EasyTreeNodeDown(T entity, RelationValue self, RelationValue target, NavigateMetadata navigateMetadata, long deep) {
        this.entity = entity;
        this.self = self;
        this.target = target;
