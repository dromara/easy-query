 ...
 */
public abstract class AbstractEntityObjectDeletable<T> extends AbstractSQLExecuteRows<EntityObjectDeletable<T>> implements EntityObjectDeletable<T> {
    ...
    public AbstractEntityObjectDeletable(Collection<T> entities, EntityDeleteExpressionBuilder entityDeleteExpressionBuilder) {
