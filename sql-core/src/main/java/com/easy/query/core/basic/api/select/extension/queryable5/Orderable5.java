...
public interface Orderable5<T1, T2, T3, T4, T5> {
    ...
    default ClientQueryable5<T1, T2, T3, T4, T5> orderByAscMerge(SQLActionExpression1<EasyTuple5<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>>> selectExpression) {
        return orderByAscMerge(true, selectExpression);
    }

    default ClientQueryable5<T1, T2, T3, T4, T5> orderByAscMerge(boolean condition, SQLActionExpression1<EasyTuple5<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>>> selectExpression) {
        return orderByAsc(condition, (t1, t2, t3, t4, t5) -> {
            selectExpression.apply(new EasyTuple5<>(t1, t2, t3, t4, t5));
        });
    }
    ...
    default ClientQueryable5<T1, T2, T3, T4, T5> orderByDescMerge(SQLActionExpression1<EasyTuple5<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>>> selectExpression) {
        return orderByDescMerge(true, selectExpression);
    }

    default ClientQueryable5<T1, T2, T3, T4, T5> orderByDescMerge(boolean condition, SQLActionExpression1<EasyTuple5<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>>> selectExpression) {
