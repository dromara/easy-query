...
public interface Orderable6<T1, T2, T3, T4, T5, T6>  {
    ...
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByAscMerge(SQLActionExpression1<Tuple6<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>>> selectExpression) {
        return orderByAscMerge(true, selectExpression);
    }

    default ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByAscMerge(boolean condition, SQLActionExpression1<Tuple6<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>>> selectExpression) {
    ...
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByDescMerge(SQLActionExpression1<Tuple6<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>>> selectExpression) {
        return orderByDescMerge(true, selectExpression);
    }

    default ClientQueryable6<T1, T2, T3, T4, T5, T6> orderByDescMerge(boolean condition, SQLActionExpression1<Tuple6<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>, ColumnOrderSelector<T4>, ColumnOrderSelector<T5>, ColumnOrderSelector<T6>>> selectExpression) {
