...
public interface ClientOverrideQueryable3<T1, T2, T3> extends ClientQueryable<T1> {
    ...
    @Override
    <TREntity> ClientQueryable3<T1, T2, T3> include(boolean condition, SQLFuncExpression1<NavigateInclude<T1>, ClientQueryable<TREntity>> navigateIncludeSQLExpression);
    ...
    @Override
    ClientQueryable3<T1, T2, T3> conditionConfigure(ConditionAccepter conditionAccepter);
}
