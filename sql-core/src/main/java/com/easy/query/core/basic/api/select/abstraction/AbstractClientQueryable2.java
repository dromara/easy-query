...
public abstract class AbstractClientQueryable2<T1, T2> extends AbstractOverrideClientQueryable2<T1, T2> implements ClientQueryable2<T1, T2> {
    ...
    private <TMember> List<TMember> selectAggregateList(SQLActionExpression2<ColumnResultSelector<T1>, ColumnResultSelector<T2>> columnSelectorExpression, ColumnFunction columnFunction, Class<TMember> resultClass) {
