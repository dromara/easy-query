...
public abstract class AbstractEntityDeletable<T> extends AbstractSqlExecuteRows<EntityDeletable<T>> implements EntityDeletable<T> {
    ...
    public long executeRows() {
        ...
        if (!entities.isEmpty()) {
            ...
            return entityExpressionExecutor.executeRows(ExecutorContext.create(runtimeContext, true, ExecuteMethodEnum.DELETE), entityDeleteExpressionBuilder, entities);
        }
        return 0;
    }
