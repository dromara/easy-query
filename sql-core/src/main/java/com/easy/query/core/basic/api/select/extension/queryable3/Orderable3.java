...
public interface Orderable3<T1, T2, T3> {
    ...
    default ClientQueryable3<T1, T2, T3> orderByAscMerge(SQLActionExpression1<EasyTuple3<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>>> selectExpression) {
        return orderByAscMerge(true, selectExpression);
    }

   default ClientQueryable3<T1, T2, T3> orderByAscMerge(boolean condition, SQLActionExpression1<EasyTuple3<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>>> selectExpression){
    ...
    default ClientQueryable3<T1, T2, T3> orderByDescMerge(SQLActionExpression1<EasyTuple3<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>>> selectExpression) {
        return orderByDescMerge(true, selectExpression);
    }

   default ClientQueryable3<T1, T2, T3> orderByDescMerge(boolean condition, SQLActionExpression1<EasyTuple3<ColumnOrderSelector<T1>, ColumnOrderSelector<T2>, ColumnOrderSelector<T3>>> selectExpression){
