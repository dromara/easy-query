...
public interface Havingable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
    ...
    default ClientQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> havingMerge(SQLActionExpression1<EasyTuple10<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>, WhereAggregatePredicate<T6>, WhereAggregatePredicate<T7>, WhereAggregatePredicate<T8>, WhereAggregatePredicate<T9>, WhereAggregatePredicate<T10>>> predicateExpression) {
        return havingMerge(true, predicateExpression);
    }

    default ClientQueryable10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> havingMerge(boolean condition, SQLActionExpression1<EasyTuple10<WhereAggregatePredicate<T1>, WhereAggregatePredicate<T2>, WhereAggregatePredicate<T3>, WhereAggregatePredicate<T4>, WhereAggregatePredicate<T5>, WhereAggregatePredicate<T6>, WhereAggregatePredicate<T7>, WhereAggregatePredicate<T8>, WhereAggregatePredicate<T9>, WhereAggregatePredicate<T10>>> predicateExpression) {
        return having(condition, (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) -> {
            predicateExpression.apply(new EasyTuple10<>(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10));
        });
    }
