...
public interface Filterable6<T1, T2, T3, T4, T5, T6> {
    ...
    default ClientQueryable6<T1, T2, T3, T4, T5, T6> whereMerge(SQLActionExpression1<Tuple6<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>>> whereExpression) {
        return whereMerge(true, whereExpression);
    }

    default ClientQueryable6<T1, T2, T3, T4, T5, T6> whereMerge(boolean condition, SQLActionExpression1<Tuple6<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>>> whereExpression) {
