...
public interface Groupable5<T1, T2, T3, T4, T5> {
    ...
    default ClientQueryable5<T1, T2, T3, T4, T5> groupByMerge(SQLActionExpression1<EasyTuple5<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>>> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default ClientQueryable5<T1, T2, T3, T4, T5> groupByMerge(boolean condition, SQLActionExpression1<EasyTuple5<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>>> selectExpression) {
