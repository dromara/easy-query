...
public interface Groupable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    default ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> groupBy(SQLExpression9<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>, ColumnGroupSelector<T7>, ColumnGroupSelector<T8>, ColumnGroupSelector<T9>> selectExpression) {
    ...
    default ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> groupByMerge(SQLExpression1<Tuple9<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>, ColumnGroupSelector<T7>, ColumnGroupSelector<T8>, ColumnGroupSelector<T9>>> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default ClientQueryable9<T1, T2, T3, T4, T5, T6, T7, T8, T9> groupByMerge(boolean condition, SQLExpression1<Tuple9<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>, ColumnGroupSelector<T7>, ColumnGroupSelector<T8>, ColumnGroupSelector<T9>>> selectExpression) {
