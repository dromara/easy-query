...
public interface Groupable7<T1, T2, T3, T4, T5, T6, T7> {
    ...
    default ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> groupByMerge(SQLActionExpression1<EasyTuple7<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>, ColumnGroupSelector<T7>>> selectExpression) {
        return groupByMerge(true, selectExpression);
    }

    default ClientQueryable7<T1, T2, T3, T4, T5, T6, T7> groupByMerge(boolean condition, SQLActionExpression1<EasyTuple7<ColumnGroupSelector<T1>, ColumnGroupSelector<T2>, ColumnGroupSelector<T3>, ColumnGroupSelector<T4>, ColumnGroupSelector<T5>, ColumnGroupSelector<T6>, ColumnGroupSelector<T7>>> selectExpression) {
