...
public interface Joinable8<T1, T2,T3,T4,T5,T6,T7,T8> {
    ...
    default <T9> ClientQueryable9<T1, T2, T3,T4,T5,T6,T7,T8,T9> leftJoinMerge(Class<T9> joinClass, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> on){
        return leftJoin(joinClass,(t,t1,t2,t3,t4,t5,t6,t7,t8)->{
            on.apply(new Tuple9<>(t,t1,t2,t3,t4,t5,t6,t7,t8));
        });
    }

    default <T9> ClientQueryable9<T1, T2, T3,T4,T5,T6,T7,T8,T9> leftJoinMerge(ClientQueryable<T9> joinQueryable, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> on){
        return leftJoin(joinQueryable,(t,t1,t2,t3,t4,t5,t6,t7,t8)->{
            on.apply(new Tuple9<>(t,t1,t2,t3,t4,t5,t6,t7,t8));
        });
    }

    default <T9> ClientQueryable9<T1, T2, T3,T4,T5,T6,T7,T8,T9> rightJoinMerge(Class<T9> joinClass, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> on){
        return rightJoin(joinClass,(t,t1,t2,t3,t4,t5,t6,t7,t8)->{
            on.apply(new Tuple9<>(t,t1,t2,t3,t4,t5,t6,t7,t8));
        });
    }

    default <T9> ClientQueryable9<T1, T2, T3,T4,T5,T6,T7,T8,T9> rightJoinMerge(ClientQueryable<T9> joinQueryable, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> on){
        return rightJoin(joinQueryable,(t,t1,t2,t3,t4,t5,t6,t7,t8)->{
            on.apply(new Tuple9<>(t,t1,t2,t3,t4,t5,t6,t7,t8));
        });
    }

    default <T9> ClientQueryable9<T1, T2, T3,T4,T5,T6,T7,T8,T9> innerJoinMerge(Class<T9> joinClass, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> on){
        return innerJoin(joinClass,(t,t1,t2,t3,t4,t5,t6,t7,t8)->{
            on.apply(new Tuple9<>(t,t1,t2,t3,t4,t5,t6,t7,t8));
        });
    }

    default <T9> ClientQueryable9<T1, T2, T3,T4,T5,T6,T7,T8,T9> innerJoinMerge(ClientQueryable<T9> joinQueryable, SQLActionExpression1<Tuple9<WherePredicate<T1>, WherePredicate<T2>, WherePredicate<T3>, WherePredicate<T4>, WherePredicate<T5>, WherePredicate<T6>, WherePredicate<T7>, WherePredicate<T8>, WherePredicate<T9>>> on){
