 ...
 * @author xuejiaming
 */
public class DefaultCTERecursiveProvider implements CTERecursiveProvider{
    @Override
    public <T> ClientQueryable<T> createCteQueryable(ClientQueryable<T> fromQueryable,ClientQueryable<T> queryable, TreeCTEOption treeCTEOption, String[] codeProperties, String[] parentCodeProperties) {
        ...
        fromQueryable.select(o -> o.sqlNativeSegment("0", c -> c.setAlias(deepColumnName)).columnAll());
        return cteQueryable;
    }
