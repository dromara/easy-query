...
public abstract class AbstractClientQueryable5<T1, T2, T3, T4, T5> extends AbstractOverrideClientQueryable5<T1, T2, T3, T4, T5> implements ClientQueryable5<T1, T2, T3, T4, T5> {
    ...
    @Override
    public <TR> Query<TR> selectAutoInclude(Class<TR> resultClass, SQLExpression5<ColumnAsSelector<T1, TR>, ColumnAsSelector<T2, TR>, ColumnAsSelector<T3, TR>, ColumnAsSelector<T4, TR>, ColumnAsSelector<T5, TR>> selectExpression, boolean replace) {
