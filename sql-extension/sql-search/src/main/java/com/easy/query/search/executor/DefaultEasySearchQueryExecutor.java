...
import com.easy.query.search.op.FilterContext;
 ...
 * @author bkbits
 */
public class DefaultEasySearchQueryExecutor
        implements EasySearchQueryExecutor {
    /**
     * 配置对象
     */
    ...
    public DefaultEasySearchQueryExecutor(EasySearchMetaDataManager metaDataManager) {
